...
@JsonIgnoreProperties(value = { "operator_status", "operator_submitted_by", "operator_submitted_on",
		"operator_submitted_id", "operator_sign","operator_signature_image", "supervisor_status", "supervisor_submit_on", "supervisor_submit_by",
		"supervisor_submit_id", "supervisor_sign",
		"supervisor_signature_image"  }, allowGetters = true, allowSetters = true)
public class OperatorSupervisorSave extends UserDateAudit {
