...
const QualityControl_f26E = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    machine_actual: "",
    machine_remarks: "",
    cross_direction_spec: "",
    cross_direction_actual: "",
    cross_direction_remarks: "",
    fibre_actual: "",
    fibre_remarks: "",
    surface_actual: "",
    surface_remarks: "",
  ...
  const handleBack = () => {
    navigate("/Precot/QualityControl/F-026E/Summary");
  };
  const rejectFlow = () => {
    setRejectModal(true);
  };
      ...
      const fetchData = async () => {
        try {
          const response = await axios.get(
            `${   API.prodUrl}/Precot/api/QcForm/getCotttonRoolGoodsF26E?product=${productName}&customer=${customerName}`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
  ...
  const runValidations = () => {
    ...
    const thicknessStandard = Number(formData.thickness_standard);
    const lowerBoundThickness = thicknessStandard - 0.2;
    const upperBoundThickness = thicknessStandard + 0.2;

    if (
      !validateField(
        formData.thickness_actual,
        lowerBoundThickness,
        upperBoundThickness,
        "Thickness (mm) (g) actual should be within " +
          lowerBoundThickness +
          " to " +
          upperBoundThickness
      )
    ...
    const slit_width_Standard = Number(formData.slit_standard);
    const lowerBoundSlitWidth = slit_width_Standard - 1;
    const upperBoundSlitWidth = slit_width_Standard + 1;

    if (
      !validateField(
        formData.slit_actual,
        lowerBoundSlitWidth,
        upperBoundSlitWidth,
        "Slit width (mm) actual should be within " +
          lowerBoundSlitWidth +
          " to " +
          upperBoundSlitWidth
      )
  ...
  const handleSave = async () => {
    ...
    if (role == "ROLE_CHEMIST") {
      ...
      apiurl = `${   API.prodUrl}/Precot/api/QcForm/SaveCottonRollGoodsF26E`;
      payload = {
        formatNo: "PH-QCL01/F-026E",
        revisionNo: "01",
        formatName: "CERTIFICATE OF ANALYSIS FOR COTTON ROLL GOODS",
        ...
        thickness_standard: formData.thickness_standard,
        thickness_actual: formData.thickness_actual,
        thickness_remarks: formData.thickness_remarks || "NA",
        slit_standard: formData.slit_standard,
        slit_actual: formData.slit_actual,
        slit_remarks: formData.slit_remarks || "NA",
        machine_spec: formData.machine_spec,
        machine_actual: formData.machine_actual,
        machine_remarks: formData.machine_remarks || "NA",
        cross_direction_spec: formData.cross_direction_spec,
        cross_direction_actual: formData.cross_direction_actual,
        cross_direction_remarks: formData.cross_direction_remarks || "NA",
        fibre_specification: formData.fibre_specification,
      ...
      apiurl = `${   API.prodUrl}/Precot/api/QcForm/ApproveOrRejectF26E`;
    ...
    if (role == "ROLE_CHEMIST") {
      ...
      const getName = (key) => {
        switch (key) {
          ...
          case "gsm_actual":
            return "GSM";
          case "thickness_standard":
          case "thickness_actual":
            return "Thickness (mm)";
          case "slit_standard":
          case "slit_actual":
            return "Slit width (mm)";
          case "machine_spec":
          case "machine_actual":
            return "Machine direction (MD)";
          case "cross_direction_spec":
          case "cross_direction_actual":
            return "Cross direction (CD)";
          case "fibre_actual":
      ...
      apiurl = `${   API.prodUrl}/Precot/api/QcForm/SubmitCottonRollGoodsF26E`;
      payload = {
        formatNo: "PH-QCL01/F-026E",
        revisionNo: "01",
        formatName: "CERTIFICATE OF ANALYSIS FOR COTTON ROLL GOODS",
  ...
  const Lov2 = [{ value: "100% Cotton", label: "100% Cotton" }];
  const Lov3 = [{ value: "Nil", label: "Nil" }];
  const Lov4 = [{ value: "Absent", label: "Absent" }];
  const Lov5 = [{ value: "Odorless", label: "Odorless" }];
  const Lov6 = [
    { value: "EP", label: "EP" },
    { value: "USP", label: "USP" },
  ];
  const Lov7 = [{ value: "OK", label: "OK" }];
  ...
  const handleBlur = (event) => {
    ...
    const thicknessStandard = Number(formData.thickness_standard);
    const lowerBoundThickness = thicknessStandard - 0;
    const upperBoundThickness = thicknessStandard + 2;

    if (
      (Number(formData.thickness_actual) < lowerBoundThickness ||
        Number(formData.thickness_actual) > upperBoundThickness) &&
      formData.thickness_actual !== "" &&
      formData.thickness_standard !== ""
    ) {
      validation.add(
        "Thickness (mm) actual should be within " +
          lowerBoundThickness +
          " to " +
          upperBoundThickness
      );
      handleClear("thickness_actual");
    }
    const slit_width_Standard = Number(formData.slit_standard);
    const tenPercents = (gsmStandard / 100) * 10;
    const lowerBoundSlitWidth = slit_width_Standard - tenPercents;
    const twentyFivePercents = (gsmStandard / 100) * 25;
    const upperBoundSlitWidth = slit_width_Standard + twentyFivePercents;

    if (
      (Number(formData.slit_actual) < lowerBoundSlitWidth ||
        Number(formData.slit_actual) > upperBoundSlitWidth) &&
      formData.slit_actual !== "" &&
      formData.slit_standard !== ""
    ) {
      validation.add(
        "Slit width (mm) actual should be within " +
          lowerBoundSlitWidth +
  ...
  return (
    <>
      <BleachingHeader
        formName={"CERTIFICATE OF ANALYSIS FOR COTTON ROLL GOODS"}
        formatNo={"PH-QCL01/F-026E"}
        unit={"UNIT H"}
        MenuBtn={
          <Button
          ...
          <Col xs={24} sm={12} md={6}>
            <Space direction="vertical" style={{ width: "100%" }}>
              ...
              <Input
                type="text"
                onKeyDown={(e) => handleKeyDown_text(e)}
                addonBefore="Reference No."
                value={formData.reference_no}
                onChange={(e) => {
                  handleInput(e.target.value, "reference_no");
                }}
                style={{ width: "100%", textAlign: "center" }}
                readOnly={status.fieldStatus}
              />
          ...
          <Col xs={24} sm={12} md={6}>
            <Space direction="vertical" style={{ width: "100%" }}>
              ...
              <Input
                ...
                onChange={(e) => {
                  handleInput(e.target.value, "pattern");
                }}
                style={{ width: "100%", textAlign: "center" }}
                readOnly={status.fieldStatus}
              />
          ...
          <div style={{ height: "50vh" }}>
            <table style={{ height: "100%" }}>
              ...
              <tr>
                ...
                <td style={{ textAlign: "center" }}>
                  ...
                  <Input
                    ...
                    value={formData.thickness_standard}
                    onChange={(e) => {
                      handleInput(e.target.value, "thickness_standard");
                    }}
                    onKeyDown={(e) => {
                      handleDigit(e, 100, "need");
                    }}
                ...
                <td style={{ textAlign: "center" }}>
                  <Input
                    ...
                    value={formData.thickness_actual}
                    onChange={(e) => {
                      handleInput(e.target.value, "thickness_actual");
                    }}
                    onKeyDown={(e) => {
                      handleDigit(e, 100, "need");
                    }}
                    onBlur={handleBlur}
                    readOnly={
                      status.fieldStatus || formData.thickness_standard == ""
                    }
                  ></Input>
                </td>
                <td style={{ textAlign: "center", padding: "0px" }}>
                  <Select
                    options={Lov1}
                    style={{ textAlign: "center", width: "300px" }}
                    value={formData.thickness_remarks}
                    onInputKeyDown={(e) => {
                      handleSelectText(e, "thickness_remarks");
                    }}
                    onChange={(e) => {
                      handleInput(e, "thickness_remarks");
                    }}
                    onBlur={handleBlur}
                    dropdownStyle={{ textAlign: "center" }}
                    showSearch
              ...
              <tr>
                ...
                <td style={{ textAlign: "center" }}>Slit width (mm)</td>
                <td style={{ textAlign: "center" }}>
                  {" "}
                  <Input
                    type="number"
                    ...
                    value={formData.slit_standard}
                    onChange={(e) => {
                      handleInput(e.target.value, "slit_standard");
                    }}
                    onBlur={handleBlur}
                    onKeyDown={(e) => {
                      handleDigit(e, 100, "need");
                ...
                <td style={{ textAlign: "center" }}>
                  <Input
                    ...
                    value={formData.slit_actual}
                    onChange={(e) => {
                      handleInput(e.target.value, "slit_actual");
                    }}
                    onBlur={handleBlur}
                    onKeyDown={(e) => {
                      handleDigit(e, 100, "need");
                    ...
                    readOnly={
                      status.fieldStatus || formData.slit_standard == ""
                    }
                  ></Input>
                </td>
                <td style={{ textAlign: "center", padding: "0px" }}>
                  <Select
                    options={Lov1}
                    style={{ textAlign: "center", width: "300px" }}
                    value={formData.slit_remarks}
                    onInputKeyDown={(e) => {
                      handleSelectText(e, "slit_remarks");
                    }}
                    onChange={(e) => {
                      handleInput(e, "slit_remarks");
                    }}
                    onBlur={handleBlur}
                    dropdownStyle={{ textAlign: "center" }}
                    showSearch
              ...
              <tr>
                ...
                <td style={{ textAlign: "center" }}>Machine direction (MD)</td>
                ...
                <td style={{ textAlign: "center" }}>
                  ...
                  <Input
                    ...
                    onKeyDown={(e) => handleKeyDown_text(e)}
                    onChange={(e) => {
                      handleInput(e.target.value, "machine_spec");
                    }}
                    value={formData.machine_spec}
                    onBlur={handleBlur}
                    style={{ width: "100%", textAlign: "center" }}
                    readOnly={status.fieldStatus}
                  />
                ...
                <td style={{ textAlign: "center" }}>
                  <Input
                    ...
                    value={formData.machine_actual}
                    onChange={(e) => {
                      handleInput(e.target.value, "machine_actual");
                    }}
                    onKeyDown={(e) => {
                      handleDigit(e, 100, "need");
                    }}
                ...
                <td style={{ textAlign: "center", padding: "0px" }}>
                  <Select
                    options={Lov1}
                    style={{ textAlign: "center", width: "300px" }}
                    value={formData.machine_remarks}
                    onInputKeyDown={(e) => {
                      handleSelectText(e, "machine_remarks");
                    }}
                    onBlur={handleBlur}
                    onChange={(e) => {
                      handleInput(e, "machine_remarks");
                    }}
                    dropdownStyle={{ textAlign: "center" }}
                    showSearch
                    filterOption={false}
              ...
              <tr>
                ...
                <td style={{ textAlign: "center" }}>Cross direction (CD)</td>
                <td style={{ textAlign: "center" }}>NA</td>
                <td style={{ textAlign: "center" }}>
                  {" "}
                  <Input
                    value={formData.cross_direction_spec}
                    type="text"
                    onKeyDown={(e) => handleKeyDown_text(e)}
                    onBlur={handleBlur}
                    onChange={(e) => {
                      handleInput(e.target.value, "cross_direction_spec");
                    }}
                    style={{ width: "100%", textAlign: "center" }}
                    readOnly={status.fieldStatus}
                  />
                ...
                <td style={{ textAlign: "center" }}>
                  <Input
                    ...
                    onBlur={handleBlur}
                    value={formData.cross_direction_actual}
                    onChange={(e) => {
                      handleInput(e.target.value, "cross_direction_actual");
                    }}
                    onKeyDown={(e) => {
                ...
                <td style={{ textAlign: "center", padding: "0px" }}>
                  <Select
                    options={Lov1}
                    value={formData.cross_direction_remarks}
                    style={{ textAlign: "center", width: "300px" }}
                    onInputKeyDown={(e) => {
                      handleSelectText(e, "cross_direction_remarks");
                    }}
                    onBlur={handleBlur}
                    onChange={(e) => {
                      handleInput(e, "cross_direction_remarks");
                    }}
                    dropdownStyle={{ textAlign: "center" }}
                    showSearch
                    filterOption={false}
...
export default QualityControl_f26E;
