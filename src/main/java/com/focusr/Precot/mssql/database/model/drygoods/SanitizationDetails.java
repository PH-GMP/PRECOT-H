...
@Data
@Entity
@Table(name = "DRYGOODS_MC_SANITIZATION", schema = AppConstants.schema, uniqueConstraints = @UniqueConstraint(columnNames = {
		"WEEK", "MONTH", "YEAR" }))
public class SanitizationDetails extends DryGoodsSuperHodSubmit {
