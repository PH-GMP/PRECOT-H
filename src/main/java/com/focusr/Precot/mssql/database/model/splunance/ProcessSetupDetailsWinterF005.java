...
@Data
@Entity
@Table(name = "SPUNLACE_PROCESS_SETUP_DETAILS_WINTER_F005", schema = AppConstants.schema, uniqueConstraints = {
		@UniqueConstraint(columnNames = { "DATE", "SHIFT", "ORDER_NO" }) })
public class ProcessSetupDetailsWinterF005 extends SpulanceSaveSubmitOperator {
