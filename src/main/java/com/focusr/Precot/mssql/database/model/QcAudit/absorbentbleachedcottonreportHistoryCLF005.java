...
@Entity
@Table(name = "ABSORBENT_BLEACHED_COTTON_REPORT_CLF005_HISTORY", schema = AppConstants.schema)
@Data
public class absorbentbleachedcottonreportHistoryCLF005 extends UserDateAudit {
		...
		@JsonIgnore
		private absorbentbleachedcottonreportCLF005Parenthistory absorbentbleachedcottonreportCLF005Parenthistory;
