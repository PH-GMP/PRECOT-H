...
//			@Param("toBmrNumber") String toBmrNumber);
	...
	List<BleachEquipmentUsageLogBookCakePressF09> findByBmrNumberRange(@Param("fromBmr") String fromBmr,
			@Param("toBmr") String toBmr);
...
//	List<BleachEquipmentUsageLogBookCakePressF09> findByBmrNumberAndSubbatch_no(String bmrNumber, String subbatchNo);
	...
	@Query(value = "SELECT DISTINCT BMR_NUMBER FROM precot.BLEACH_EQUIPMENT_USAGE_LOGBOOK_CAKE_PRESS_F09 WHERE HOD_STATUS IN ('HOD_APPROVED') ORDER BY BMR_NUMBER DESC", nativeQuery = true)
