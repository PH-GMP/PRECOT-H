...
@Data
@Entity
@Table(name = "SPUNLACE_PROCESS_SETUP_VERIFICATION_OPENING_LINE_HISTORY_F002", schema = AppConstants.schema)
public class ProcessSetupVerificationOpeningLineHistoryF002 extends SpulanceSaveSubmitOperator{
	@Id
