...
function Bleaching_f02A() {
  ...
  const [printDataValue, setPrintDataValue] = useState([]);
  ...
  const handleDatePrintChange = (selectYear) => {
  ...
  const generateRow = (item, totalCols = 64) => {
    const tds = [];
    ...
    for (let i = 0; i < item.length; i++) {
      tds.push(
        <td colSpan="2" key={i}>
          {transformValue(item[i].floor_cleaninh)}
        </td>
      );
    }

    // Fill the rest with empty cells
    const emptyCellsNeeded = totalCols / 2 - item.length;
    for (let i = 0; i < emptyCellsNeeded; i++) {
      tds.push(<td colSpan="2" key={item.length + i}></td>);
    }
  ...
  const fetchPrintData = (newData, month, year) => {
    ...
    return records.map((record) => {
      ...
      return {
        ...
        remark: transformValue(record.remarks),
        // remark: record.remarks,
      };
    });
  };

  //   const result = fetchPrintData(newData, state);
  // // console.log(result);
  ...
  const fetchData = async () => {
    ...
    // console.log("Date 2A", date);
    const dateParts = state.date.split("-");
    // console.log("Dateparts 2A", dateParts);
    const year2 = parseInt(dateParts[0], 10);
    const month2 = parseInt(dateParts[1], 10) - 1;
    const newdate1 = new Date(year2, month2);
    const month = newdate1.toLocaleString("default", { month: "long" });
    const year = newdate1.toLocaleString("default", { year: "numeric" });
    setMonth(month);
    setYear(year);
    setNewDate(date);
    // console.log("2A-Month", month);
    // console.log("2A-Year", year);
  ...
  const handleSubmit = async () => {
    ...
    const payload = {
      ...
      // remarks: remark,
      floor_cleaninh: floorcleaning === "" ? "N/A" : floorcleaning,
      removel_unwanted_meterials:
        removalofunwantedmaterials === "" ? "N/A" : removalofunwantedmaterials,
      side_wall_corners: sidewallscorners === "" ? "N/A" : sidewallscorners,
      windows: windows === "" ? "N/A" : windows,
      emergency_door: emergencyDoors === "" ? "N/A" : emergencyDoors,
      fire_extinguishers: fireExtinguishers === "" ? "N/A" : fireExtinguishers,
      first_aid_box: firstAidBox === "" ? "N/A" : firstAidBox,
      rapid_doors: rapidDoors === "" ? "N/A" : rapidDoors,
                ...
                {dateLov.map((date, rowIndex) => {
                  ...
                  return (
                    <td key={rowIndex} className="data-border" colSpan="2">
                      ...
                      >
                        {printData ? printData.floorcleaning : "-"}
                      </p>
                    </td>
                  );
                })}
                ...
                {dateLov.map((date, rowIndex) => {
                  ...
                  return (
                    <td key={rowIndex} className="data-border" colSpan="2">
                      ...
                      >
                        {printData ? printData.removalofunwantedmaterials : "-"}
                      </p>
                    </td>
                  );
                })}
                ...
                {dateLov.map((date, rowIndex) => {
                  ...
                  return (
                    <td key={rowIndex} className="data-border" colSpan="2">
                      ...
                      >
                        {printData ? printData.sidewallscorners : "-"}
                      </p>
                    </td>
                  );
                })}
                ...
                {dateLov.map((date, rowIndex) => {
                  ...
                  return (
                    <td key={rowIndex} className="data-border" colSpan="2">
                      ...
                      >
                        {printData ? printData.emergencyDoors : "-"}
                      </p>
                    </td>
                  );
                })}
                ...
                {dateLov.map((date, rowIndex) => {
                  ...
                  return (
                    <td key={rowIndex} className="data-border" colSpan="2">
                      ...
                      >
                        {printData ? printData.fireExtinguishers : "-"}
                      </p>
                    </td>
                  );
                })}
                ...
                {dateLov.map((date, rowIndex) => {
                  ...
                  return (
                    <td key={rowIndex} className="data-border" colSpan="2">
                      ...
                      >
                        {printData ? printData.firstAidBox : "-"}
                      </p>
                    </td>
                  );
                })}
                ...
                {dateLov.map((date, rowIndex) => {
                  ...
                  return (
                    <td key={rowIndex} className="data-border" colSpan="2">
                      ...
                      >
                        {printData ? printData.rapidDoors : "-"}
                      </p>
                    </td>
                  );
                })}
