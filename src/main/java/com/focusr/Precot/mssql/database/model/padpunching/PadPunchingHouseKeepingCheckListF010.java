...
@Entity
@Table(name = "PADPUNCHING_HOUSE_KEEP_CLEAN_CHECK_LIST_F010",schema=AppConstants.schema, uniqueConstraints = {
		@UniqueConstraint(columnNames = { "DATE" }) })
public class PadPunchingHouseKeepingCheckListF010 {
...
//Sup
	...
	public void setFloor_cleaning(String floor_cleaninh) {
		this.floor_cleaning = floor_cleaninh;
	}
