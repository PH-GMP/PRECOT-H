...
@Data
@Entity
@Table(name = "SPUNLACE_PROCESS_SETUP_DETAILS_JETLACE_AND_DRYER_HISTORY_F003",schema=AppConstants.schema)
public class ProcessSetupDetailsJetlaceAndDryerHistoryF003 extends SpulanceSaveSubmitOperator{
	@Id
