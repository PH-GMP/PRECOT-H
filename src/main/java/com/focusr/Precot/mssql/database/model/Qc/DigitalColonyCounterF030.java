...
@Data
@Entity
@Table(name = "DIGITAL_COLONY_COUNTER_F030", schema = AppConstants.schema, uniqueConstraints = {
		@UniqueConstraint(columnNames = { "MONTH", "YEAR", "EQUIP_ID" }) })

public class DigitalColonyCounterF030 extends UserDateAudit {
