...
@Entity
@Table(name = "BUDS_DAILY_PRODUCTION_SLIVER_LINE_HISTORY", schema = AppConstants.schema)
public class BudsDailyProductionSliverLineHistory extends UserDateAudit{
...
//	@JsonIgnore
//    private BudsDailyProductionSliverHeaderHistory sliverProduction;
