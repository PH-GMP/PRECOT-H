...
const Equipment_Used_Process = (props) => {
  ...
  const [equipmentData, setEquipmentData] = useState([
    ...
    {
      equipmentName: "TC 10 CARD-01",
      equipmentCode: "PH-E/I-BAL04",
      calibrationDate: "",
      dueDate: "",
      checked_by: "",
      remarks: "",
    ...
    {
      equipmentName: "TC 10 CARD-02",
      equipmentCode: "PH-E/I-BAL05",
      calibrationDate: "",
      dueDate: "",
      checked_by: "",
      remarks: "",
    ...
    {
      equipmentName: "TEXCORE",
      equipmentCode: "PH-E/I-BAL07",
      calibrationDate: "",
      dueDate: "",
      checked_by: "",
      remarks: "",
  ...
  useEffect(() => {
    if (props.batchNo) {
      axios
        .get(
          `${API.prodUrl}/Precot/api/cottonBall/05.GetProcessEqupDetails?batch_no=${props.batchNo}`,
          {
            headers: {
              Authorization: `Bearer ${localStorage.getItem("token")}`,
            },
  ...
  //       message.error(
  //         `Calibration Date is required for ${equipment.equipmentName}`
  //       );
  //       return false;
  //     }
  //     if (!equipment.dueDate) {
  //       message.error(`Due Date is required for ${equipment.equipmentName}`);
  //       return false;
  //     }
  //     if (!equipment.checked_by) {
  //       message.error(`Checked By is required for ${equipment.equipmentName}`);
  //       return false;
  //     }
  //   }
  //   return true;
  ...
  const handleSave = async () => {
    try {
      ...
      const response = await axios.post(
        `${API.prodUrl}/Precot/api/cottonBall/05.SaveProcessingEquipments`,
        payload,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${API.prodUrl}/Precot/api/cottonBall/05.SubmitProcessingEquipments`,
        payload,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
