...
const QA_F037_Summary = () => {
  ...
  const columns = [
...

    {
      ...
      render: (text) =>
        text
          ? text.replace(/QA_INS/g, "QA_INSPECTOR").replace(/_/g, " ")
          : text,
    },
  ...
  const handleEdit = (record) => {
    navigate("/Precot/QualityAssurance/QA_F037", {
      state: {
          ...
          printResponseData?.map((responseData, index) => (
            <table style={{ tableLayout: "fixed", width: "1000px" }}>
              ...
              <tbody>
                ...
                <tr>
                  <td style={{ padding: "5px" }}>
                    Total Quantity:{responseData?.totalQuantity || "N/A"}
                  </td>
                ...
                <tr>
                  ...
                  <td style={{ padding: "5px", textAlign: "center" }}>
                    {responseData?.noOfFoldsSpecification || "N/A"}
                  </td>
                  <td
                    style={{ padding: "5px", textAlign: "center" }}
                    colSpan={2}
                  >
                    {responseData?.noOfFoldsActualFindings || "N/A"}
                  </td>
                </tr>
                <tr>
                  <td style={{ padding: "5px", textAlign: "center" }}>
                  ...
                  <td style={{ padding: "5px", textAlign: "center" }}>
                    {responseData?.moistureSamplesize || "N/A"}
                  </td>
                  <td
                    style={{ padding: "5px", textAlign: "center" }}
                    colSpan={2}
                  >
                    {responseData?.moistureActualFindings || "N/A"}
                  </td>
                </tr>
                ...
                <tr>
                  <td style={{ padding: "5px", textAlign: "center" }}>
                    Less Cotton / Loose Cotton / Tail Ends
                  </td>
                  <td style={{ padding: "5px", textAlign: "center" }}>
                ...
                <tr>
                  <td colSpan={5} style={{ padding: "5px", textAlign: "left" }}>
                    Remarks: {responseData?.remarks || "N/A"}
                  </td>
                </tr>
                <tr>
                  <td style={{ padding: "5px", textAlign: "center" }}>
...
export default QA_F037_Summary;
