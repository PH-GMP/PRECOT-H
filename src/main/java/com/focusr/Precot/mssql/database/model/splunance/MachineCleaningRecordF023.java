...
@Data
@Entity
@Table(name = "SPUNLACE_MACHINE_CLEANING_RECORD_F023", schema = AppConstants.schema, uniqueConstraints = {
		@UniqueConstraint(columnNames = { "DATE", "MONTH", "YEAR" }) })
public class MachineCleaningRecordF023 extends SpunlaceSaveSumbitSupervisor{
