...
const Qa_Release = (props) => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `${API.prodUrl}/Precot/api/CottonWoolRall/13.GetQaRelease?batch_no=${props.batchNo}`,
          {
            headers: {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${API.prodUrl}/Precot/api/CottonWoolRall/13.SaveQaRelease`,
        payload,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${API.prodUrl}/Precot/api/CottonWoolRall/13.SubmitQaRelease`,
        payload,
        {
          headers: {
            Authorization: `Bearer ${token}`,
        ...
        >
          <Button
            ...
            style={{
              ...
              fontWeight: "bold",
              display:
                !props.loggedInQAManandQAdes || formStatus.fieldStatus
                  ? "none"
                  : "block",
            }}
            shape="round"
          ...
          <tr>
            ...
            <td>
              ...
              <Input
                ...
                readOnly={
                  formStatus.fieldStatus || !props.loggedInQAManandQAdes
                }
                max={todayDateTime}
              />
            </td>
