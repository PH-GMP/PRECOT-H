...
@Entity
@Table(name = "BUDS_BMR_EQUIPMENT_ANNEXURE_LINE", schema = AppConstants.schema)
public class BudsBmrEquipmentAnnexureLine extends UserDateAudit {
	...
	@JsonIgnore
	private BudsBmrEquipmentAnnexureHeader equipmentRecord;
	...
	public BudsBmrEquipmentAnnexureHeader getEquipmentRecord() {
		return equipmentRecord;
	}

	public void setEquipmentRecord(BudsBmrEquipmentAnnexureHeader equipmentRecord) {
