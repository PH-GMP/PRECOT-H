...
@Entity
@Table(name = "MICROBIOLOGICAL_ANALYSIS_REPORT_F20_HISTORY", schema = AppConstants.schema)
@Data
public class microbiologicalAnalyisisReportHistoryF20 extends UserDateAudit{
