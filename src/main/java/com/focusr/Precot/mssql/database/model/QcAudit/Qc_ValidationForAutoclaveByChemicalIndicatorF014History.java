...
@Data
@Entity
@Table(name = "QC_VALIDATION_FOR_AUTOCLAVE_BY_CHEMICAL_INDICATORF014_HISTORY", schema = AppConstants.schema)
public class Qc_ValidationForAutoclaveByChemicalIndicatorF014History extends UserDateAudit {
