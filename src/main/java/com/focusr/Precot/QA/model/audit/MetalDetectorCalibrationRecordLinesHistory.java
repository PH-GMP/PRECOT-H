...
@Data
@Entity
@Table(name = "METAL_DETECTOR_CALIBRATION_RECORDS_LINES_HISTORY", schema = AppConstants.schema)
public class MetalDetectorCalibrationRecordLinesHistory {
	@Id
...
//	    @JsonIgnore
//	    private MetalDetectorCalibrationRecordHistory metaldetectorcalibrationrecordhistory;
}
