...
@Data
@Entity
@Table(name = "DRY_GOODS_HOUSE_KEEP_CLEAN_CHECK_LIST_HISTORY_F14", schema = AppConstants.schema)
public class DryGoodsHouseKeepingCheckListHistoryF14 extends UserDateAudit {
