...
@Data
@Entity
@Table(name = "ETP_LAB_SAMPLE_INWARD_BOOK", schema = AppConstants.schema, uniqueConstraints = {
		@UniqueConstraint(columnNames = { "DATE"}) })
public class etpLogBookClF003 {
	...
	private String hod_status_micro;

	@Column(name = "QC_SUBMIT_ON_MICRO")
	private Date hod_submit_on_micro;
	...
	@Column(name = "QC_SUBMIT_BY_MICRO")
	private String hod_submit_by_micro;

	@Column(name = "QC_SUBMIT_ID_MICRO")
	private Long hod_submit_id_micro;
