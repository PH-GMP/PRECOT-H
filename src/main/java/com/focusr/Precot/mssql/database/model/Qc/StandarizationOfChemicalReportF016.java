...
@Data
@Entity
@Table(name = "STANDARIZATION_OF_CHEMICAL_REPORT_F016", schema = AppConstants.schema, uniqueConstraints = {
		@UniqueConstraint(columnNames = {"DATE", "SHIFT", "TO_BE_NAME_OF_SOLUTION"}) })

public class StandarizationOfChemicalReportF016 extends UserDateAudit{
