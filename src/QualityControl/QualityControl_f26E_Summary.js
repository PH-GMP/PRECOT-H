...
const QualityControl_f26E_Summary = () => {
  ...
  const productLovApiPrint = async (value, type) => {
    try {
      const response = await axios.get(
        `${API.prodUrl}/Precot/api/QcForm/ProductF26?customer=${value}&formNo=F26E`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  useEffect(() => {
    if (!initialized.current) {
      ...
      const fetchData = async () => {
        try {
          const response = await axios.get(
            `${API.prodUrl}/Precot/api/QcForm/F26ECottonRoolGoodsSummary`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
  ...
  const handleOk = () => {
    ...
    navigate(`/Precot/QualityControl/F-026E`, {
      state: {
  ...
  const handlePrint = async () => {
    ...
    try {
      const response = await axios.get(
        `${API.prodUrl}/Precot/api/QcForm/PrintApiF26E?product=${printParams.productName}&customer=${printParams.customerName}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  #section-to-print-san table td {
    ...
    `}
        ...
        <div className="page-break">
          <table style={{ borderCollapse: "collapse", width: "100%" }}>
            ...
            <tr>
              ...
              <td
                ...
                rowSpan={4}
              >
                CERTIFICATE OF ANALYSIS FOR COTTON ROLL GOODS
              </td>
              <td style={{ padding: "0.5em" }}>Format No.:</td>
              <td style={{ padding: "0.5em" }}>PH-QCL01/F-026E</td>
            </tr>
            <tr>
          ...
          <table style={{ height: "100%" }}>
            ...
            <tr>
              ...
              <td style={{ textAlign: "left" }}>Thickness (mm)</td>
              <td style={{ textAlign: "center" }}>
                {printData.thickness_standard}
              </td>
              <td style={{ textAlign: "center" }}>± 0.2 </td>
              <td style={{ textAlign: "center" }}>
                {printData.thickness_actual}
              </td>
              <td style={{ textAlign: "center", padding: "0px" }}>
                {printData.thickness_remarks}
              </td>
            </tr>
            <tr>
              <td style={{ textAlign: "center" }}> 3 </td>
              <td style={{ textAlign: "left" }}>Slit width (mm)</td>
              <td style={{ textAlign: "center" }}>{printData.slit_standard}</td>
              <td style={{ textAlign: "center" }}>± 1 </td>
              <td style={{ textAlign: "center" }}>{printData.slit_actual}</td>
              <td style={{ textAlign: "center", padding: "0px" }}>
                {printData.slit_remarks}
              </td>
            </tr>
            <tr>
              <td style={{ textAlign: "center" }}> 4 </td>
              <td style={{ textAlign: "left" }}>Machine direction (MD)</td>
              <td style={{ textAlign: "center" }}>NA</td>
              <td style={{ textAlign: "center" }}>{printData.machine_spec}</td>
              <td style={{ textAlign: "center" }}>
                {printData.machine_actual}
              </td>
              <td style={{ textAlign: "center", padding: "0px" }}>
                {printData.machine_remarks}
              </td>
            </tr>
            <tr>
              <td style={{ textAlign: "center" }}> 5 </td>
              <td style={{ textAlign: "left" }}>Cross direction (CD)</td>
              <td style={{ textAlign: "center" }}>NA</td>
              <td style={{ textAlign: "center" }}>
                {printData.cross_direction_spec}{" "}
              </td>
              <td style={{ textAlign: "center" }}>
                {printData.cross_direction_actual}
              </td>
              <td style={{ textAlign: "center", padding: "0px" }}>
                {printData.cross_direction_remarks}
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td style={{ textAlign: "center" }}>
                Any Foam <br />
                Present must <br /> not cover the <br />
                entire surface <br /> of the liquid
              </td>
              <td style={{ textAlign: "center" }}>
            ...
            <tr>
              ...
              <td style={{ textAlign: "center" }}>EP</td>
              <td style={{ textAlign: "center" }}>
                No intense blue <br /> fluorescence . <br /> Few isolated
                <br /> fibers
                <br /> passable
              </td>
              <td style={{ textAlign: "center" }}>
      ...
      />
      <Modal
        title="COA FOR COTTON ROLL GOODS (Print)"
        open={isModalPrint}
      ...
      >
        ...
        {/* <Select options={formLov.productLov} style={{ width: '300px', textAlign: 'center' }} value={formParams.productName} onChange={(e) => { handleSelect(e, 'productName') }} dropdownStyle={{ textAlign: 'center' }} showSearch  ></Select>
         */}
        <CreatableSelect
...
export default QualityControl_f26E_Summary;
