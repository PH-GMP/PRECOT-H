...
const QualityControl_f26D_Summary = () => {
  ...
  const productLovApiPrint = async (value, type) => {
    try {
      const response = await axios.get(
        `${API.prodUrl}/Precot/api/QcForm/ProductF26?customer=${value}&formNo=F26D`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  useEffect(() => {
    if (!initialized.current) {
      ...
      const fetchData = async () => {
        try {
          const response = await axios.get(
            `${API.prodUrl}/Precot/api/QcForm/F26DCottonWoolPleatSummary`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
  ...
  const handleOk = () => {
    ...
    navigate(`/Precot/QualityControl/F-026D`, {
      state: {
  ...
  const handlePrint = async () => {
    ...
    try {
      const response = await axios.get(
        `${API.prodUrl}/Precot/api/QcForm/PrintApiF26D?product=${printParams.productName}&customer=${printParams.customerName}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  #section-to-print-san table td {
    ...
    `}
        ...
        <div className="page-break">
          <table style={{ borderCollapse: "collapse", width: "100%" }}>
            ...
            <tr>
              ...
              <td
                ...
                rowSpan={4}
              >
                CERTIFICATE OF ANALYSIS FOR COTTON PLEAT
              </td>
              <td style={{ padding: "0.5em" }}>Format No.:</td>
              <td style={{ padding: "0.5em" }}>PH-QCL01/F-026D</td>
            </tr>
            <tr>
          ...
          <table style={{ height: "100%" }}>
            ...
            <tr>
              ...
              <td style={{ textAlign: "left" }}>Width(mm)</td>
              <td style={{ textAlign: "center" }}>
                {printData.width_standard}
              </td>
              <td style={{ textAlign: "center" }}>± 1%</td>
              <td style={{ textAlign: "center" }}>{printData.width_actual}</td>
              <td style={{ textAlign: "center", padding: "0px" }}>
                {printData.width_remarks}
              </td>
            </tr>
            <tr>
              <td style={{ textAlign: "center" }}> 2 </td>
              <td style={{ textAlign: "left" }}>Gross weight with bag (g)</td>
              <td style={{ textAlign: "center" }}>
                {printData.gross_weight_standard}
              </td>
            ...
            <tr>
              ...
              <td style={{ textAlign: "left" }}>No. of Folds</td>
              <td style={{ textAlign: "center" }}>
                {printData.no_of_folds_standard}
              </td>
              <td style={{ textAlign: "center" }}>± 2</td>
              <td style={{ textAlign: "center" }}>
                {printData.no_of_folds_actual}
              </td>
              <td style={{ textAlign: "center", padding: "0px" }}>
                {printData.no_of_folds_remarks}
              </td>
            </tr>
            <tr>
      ...
      />
      <Modal
        title="COA FOR COTTON PLEAT (Print)"
        open={isModalPrint}
...
export default QualityControl_f26D_Summary;
