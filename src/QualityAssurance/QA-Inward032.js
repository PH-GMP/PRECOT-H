...
const QA_Inward032 = () => {
  ...
  useEffect(() => {
    ...
    const sum9 = Number(Number12) + Number(Number13) + Number(Number14);
    setTotal9(sum9);
  });
  ...
  const handleApprove = async () => {
    ...
    const res = await axios
      ...
      .then((res) => {
        ...
        navigate("/Precot/QA/Inward032/Summary");
      })
      .catch((err) => {
        setLoading(false);
  ...
  const IIrgeneration = async () => {
    try {
      ...
      const response = await axios.get(
        `${
          API.prodUrl
        }/Precot/api/qa/number/generation?formNumber=${"PH-QAD01-F-032"}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
  ...
  const checkBmrExists = async (date) => {
    try {
      ...
      const response = await axios.get(
        `${
          API.prodUrl
        }/Precot/api/qa/getdetailsbyParamInward?formatNo=${"PH-QAD01-F-032"}&gr_date=${newDate}&supplierName=${Suppliers}&invoice_no=${invoice}&item_description=${productdesc}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
      ...
      setMaxdefect2(response.data.body.line2[7].maximum_no_of_defects);
      setTotal8(response.data.body.line2[7].total_no_of_defects);
      ...
      setMaxdefect3(response.data.body.line2[11].maximum_no_of_defects);
      setTotal9(response.data.body.line2[11].total_no_of_defects);
  ...
  const saveData = () => {
    ...
    const payload = {
      unit: "Unit H",
      formatNo: "PH-QAD01-F-032",
      formatName: "INWARD INSPECTION REPORT(BUDS- STICK)",
      ...
      line1: [
        ...
        {
          parameter: "Total Length of Stick (mm)",
        ...
        {
          parameter: "Diameter of Stick / Stick Dia",
        ...
        {
          parameter: "Weight of 10 buds (gm)",
      ...
      line2: [
        ...
        {
          category: "Critical(AQL - Nil)",
          defects: "Buds breakage at serration",
        ...
        {
          category: "Critical(AQL - Nil)",
          defects: "Inconsistent Dimension",
        ...
        {
          category: "Critical(AQL - Nil)",
          defects: "Contaminations (Foreign Matl.)",
        ...
        {
          category: "Major(AQL - 2.5)",
          defects: "Less Adhesion Strength",
        ...
        <div>
          ...
          >
            ...
            <tbody>
              {/* <tr>
                <Td colSpan="1">1</Td>
                <Td colSpan="5">Quantity per pack</Td>
                <Td colSpan="5">
                  <input
                    type="text"
              ...
              <tr>
                <Td colSpan="1">1</Td>
                <Td colSpan="5">Total Length of Stick (mm)</Td>
                <Td colSpan="5">
                  <input
                    type="text"
              ...
              <tr>
                <Td colSpan="1">2</Td>
                <Td colSpan="5">Diameter of Stick / Stick Dia.</Td>
                <Td colSpan="5">
                  <input
                    type="text"
                    className="inp-new"
              ...
              <tr>
                <Td colSpan="1">3</Td>
                <Td colSpan="5">Stick Length (mm)</Td>
                <Td colSpan="5">
                  {" "}
                  <input
                    type="text"
              ...
              <tr>
                <Td colSpan="1">4</Td>
                <Td colSpan="5">Weight of 10 buds (gm)</Td>
                <Td colSpan="5">
                  <input
                    type="text"
                    className="inp-new"
          ...
          >
            ...
            <>
              <tr>
                ...
                <Td colSpan="4">Stick Splintering</Td>
                <Td colSpan="4">
                  <input
                    type="text"
                    className="inp-new"
              ...
              <tr>
                <Td colSpan="1">2</Td>
                <Td colSpan="4">Buds breakage at serration</Td>
                <Td colSpan="4">
                  <input
                    type="text"
                    className="inp-new"
              ...
              <tr>
                <Td colSpan="1">3</Td>
                <Td colSpan="4">Inconsistent Dimension </Td>
                <Td colSpan="4">
                  <input
                    type="text"
                    className="inp-new"
              ...
              <tr>
                <Td colSpan="1">6</Td>
                <Td colSpan="4">Contaminations (Foreign Matl.)</Td>
                <Td colSpan="4">
                  <input
                    type="text"
                    className="inp-new"
        ...
        <div>
          ...
          >
            <tr>
              ...
              <Td colSpan="4" rowSpan={4} disabled={condition}>
                {total8}
              </Td>
            ...
            <tr>
              <Td colSpan="1">2</Td>
              <Td colSpan="4">Less Adhesion Strength</Td>
              <Td colSpan="4">
                <input
                  type="text"
                  className="inp-new"
            ...
            <tr>
              <Td colSpan="1">4</Td>
              <Td colSpan="4">Moisture Content</Td>
              <Td colSpan="4">
                <input
                  type="text"
                  className="inp-new"
