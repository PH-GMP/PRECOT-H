...
@Data
@Entity
@Table(name = "QA_CUSTOMER_COMPLAINT_REGISTER_FORM", schema = AppConstants.schema, uniqueConstraints = {
		@UniqueConstraint(columnNames = { "CCF_NO" }) })
public class QaCustomerComplaintRegisterForm extends UserDateAudit {
