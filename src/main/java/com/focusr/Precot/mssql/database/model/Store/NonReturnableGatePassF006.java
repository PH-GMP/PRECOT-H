...
@Entity
@Table(name = "STORE_NON_RETURNABLE_GATE_PASS_F006",schema = AppConstants.schema, uniqueConstraints = {
        @UniqueConstraint(columnNames = {"GATE_PASS_NO"})
})
@Data
public class NonReturnableGatePassF006 extends UserDateAudit{
    ...
    @OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "gatePass")
    private List<NonReturnableGoodsDetail> goodsDetails;
