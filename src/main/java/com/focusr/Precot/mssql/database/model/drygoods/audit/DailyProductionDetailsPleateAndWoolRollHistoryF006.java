...
@Data
@Entity
@Table(name = "DRYGOODS_DAILY_PRODUCTION_PLEATE_AND_WOOL_ROLL_F006_HISTORY", schema = AppConstants.schema
		)
public class DailyProductionDetailsPleateAndWoolRollHistoryF006 extends SpulanceSaveSubmitOperator {
	@Id
