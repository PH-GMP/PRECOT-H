  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        let apiUrl = `${
         API.prodUrl
        }/Precot/api/qa/getSummarydetailsInward?formatNo=${"PH-QAD01/F-031"}`;
  ...
  const fetchPrintGet = async (date) => {
    ...
    try {
      ...
      const response = await axios.get(
        `${
         API.prodUrl
        }/Precot/api/qa/getdetailsForPrintInward?formatNo=${"PH-QAD01/F-031"}&gr_date=${date}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
  ...
  const handlePrintSupplier = async (SelectedPrintSupplier) => {
    try {
      const response = await axios.get(
        `${
         API.prodUrl
        }/Precot/api/qa/getdetailsForPrintInward?formatNo=${"PH-QAD01/F-031"}&gr_date=${printDate}&supplierName=${SelectedPrintSupplier}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
  ...
  const handlePrintInvoiceSelection = async (SelectedInvoicePrint) => {
    try {
      ...
      const response = await axios.get(
        `${
         API.prodUrl
        }/Precot/api/qa/getdetailsForPrintInward?formatNo=${"PH-QAD01/F-031"}&gr_date=${printDate}&supplierName=${SelectedPrintSupplier}&invoice_no=${SelectedInvoicePrint}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
  ...
  const handlePrintiirselection = async (SelectediirNumbers) => {
    try {
      ...
      const response = await axios.get(
        `${
         API.prodUrl
        }/Precot/api/qa/getdetailsForPrintInward?formatNo=${"PH-QAD01/F-031"}&gr_date=${printDate}&supplierName=${SelectedPrintSupplier}&invoice_no=${SelectedInvoicePrint}&iir_no=${SelectediirNumbers}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
    ...
    <div>
      ...
      <div id="section-to-print">
        ...
        <table style={{ tableLayout: "fixed" }}>
          <thead>
            <tr>
              <td colSpan="20" style={{ border: "none", height: "5px" }}></td>
            </tr>
            ...
            <tr>
              ...
              <th colSpan={9} rowspan={4} style={{ textAlign: "center" }}>
                INWARD INSPECTION REPORT (for Zip lock)
              </th>
              <th colSpan={3}>Format No.:</th>
              <th colSpan={3}>PH-QAD01/F-031</th>
            </tr>
            <tr>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colSpan={5}>GR Date:{formattedgrDate} </td>
              <td colSpan={5}>GR No: {printResponseData?.[0]?.gr_no} </td>
              <td colSpan={4}>PDS No.:{printResponseData?.[0]?.pds_no}</td>
            </tr>
            ...
            <tr>
              ...
              <td colSpan={6}>Thickness of Bag (micron)</td>
              <td colSpan={6}>
            ...
            <tr>
              ...
              <td colSpan={6}>Size of Bag (L x W) in mm</td>
              <td colSpan={6}>
            ...
            <tr>
              ...
              <td colSpan={6}>Pre-cut Length</td>
              <td colSpan={6}>
            ...
            <tr>
              ...
              <td colSpan={5}>Old / Obsolete/Incorrect Artwork</td>
              <td colSpan={4}>
            ...
            <tr>
              ...
              <td colSpan={5}>Bar code Wrong / Not Scanning</td>
              <td colSpan={4}>
            ...
            <tr>
              ...
              <td colSpan={5}>Different type of bags</td>
              <td colSpan={4}>
            ...
            <tr>
              ...
              <td colSpan={5}>Side sealing/ Ziplock sealing </td>
              <td colSpan={4}>
                {printResponseData?.[0]?.line2[3].no_of_defects}
              </td>
              <td colSpan={4} rowSpan={7}>
                {printResponseData?.[0]?.line2[3].total_no_of_defects}
              </td>
              <td colSpan={4} rowSpan={7}>
                {printResponseData?.[0]?.line2[3].maximum_no_of_defects}
              </td>
            </tr>
            <tr>
              <td colSpan={1} style={{ textAlign: "center" }}>
              ...
              <td colSpan={5}>Shifted Artwork /Illegible Printing</td>
              <td colSpan={4}>
            ...
            <tr>
              ...
              <td colSpan={5}>Major colour shade deviation</td>
              <td colSpan={4}>
            ...
            <tr>
              ...
              <td colSpan={5}>Wrong Bag Dimension/Flap dimension </td>
              <td colSpan={4}>
            ...
            <tr>
              ...
              <td colSpan={5}>Zip lock Quality Not Good</td>
              <td colSpan={4}>
            ...
            <tr>
              ...
              <td colSpan={5}>Wicket Hole Centering</td>
              <td colSpan={4}>
            ...
            <tr>
              ...
              <td colSpan={5}>Hanging Hole Centering</td>
              <td colSpan={4}>
            ...
            <tr>
              ...
              <td colSpan={2} rowSpan={6} style={{ textAlign: "center" }}>
                Minor
                <br />
                (AQL - 4)
              </td>
              <td colSpan={5}>Unwanted Colour Spot</td>
              <td colSpan={4}>
                {printResponseData?.[0]?.line2[10].no_of_defects}
              </td>
              <td colSpan={4} rowSpan={6}>
                {printResponseData?.[0]?.line2[10].total_no_of_defects}
              </td>
              <td colSpan={4} rowSpan={6}>
                {printResponseData?.[0]?.line2[10].maximum_no_of_defects}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td colSpan={5}>Sticky Bags /Artwork Damage</td>
              <td colSpan={4}>
                {printResponseData?.[0]?.line2[11].no_of_defects}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td colSpan={5}>Less/ More Thickness of bag(micron)</td>
              <td colSpan={4}>
                {printResponseData?.[0]?.line2[12].no_of_defects}
              </td>
            </tr>
            <tr>
              <td colSpan={1} style={{ textAlign: "center" }}>
              ...
              <td colSpan={5}>Minor colour shade deviation</td>
              <td colSpan={4}>
                {printResponseData?.[0]?.line2[13].no_of_defects}
              </td>
            </tr>
            <tr>
              <td colSpan={1} style={{ textAlign: "center" }}>
              ...
              <td colSpan={5}>Damaged /No Perforation / Breathing Holes</td>
              <td colSpan={4}>
                {printResponseData?.[0]?.line2[14].no_of_defects}
              </td>
            </tr>
            <tr>
              <td colSpan={1} style={{ textAlign: "center" }}>
              ...
              <td colSpan={5}>Folding/ Wrinkles/alignment</td>
              <td colSpan={4}>
                {printResponseData?.[0]?.line2[15].no_of_defects}
              </td>
            </tr>
        ...
        <table style={{ tableLayout: "fixed" }}>
          ...
          <tbody>
            <tr>
              <td colSpan={20}>
                Lot Status:{printResponseData?.[0]?.lot_status}
              </td>
            </tr>
      ...
      >
        ...
        >
          ...
          <Select
            ...
            value={SelectedInvoicePrint || undefined}
            onChange={(value) => {
        ...
        >
          ...
          <Select
            ...
            value={SelectediirNumbers || undefined}
            onChange={(value) => {
...
export default QA_Inward031_Sum;
