...
const QualityControl_f26B = () => {
  ...
  const handleBack = () => {
    navigate("/Precot/QualityControl/F-026B/Summary");
  };
  const rejectFlow = () => {
    setRejectModal(true);
  };
      ...
      const fetchData = async () => {
        try {
          const response = await axios.get(
            `${API.prodUrl}/Precot/api/QcForm/getCotttonPadF26B?product=${productName}&customer=${customerName}`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
  ...
  const runValidations = () => {
    // ---------- Test Type 1 ---------------
    const weightStandard = Number(formData.weight_standard);
    const tenPercentWeight = (weightStandard / 100) * 10;
    const lowerBoundWeight = weightStandard - tenPercentWeight;
    const upperBoundWeight = weightStandard + tenPercentWeight;

    if (
      !validateField(
        formData.weight_actual,
        lowerBoundWeight,
        upperBoundWeight,
        "Weight (g/ball) actual should be within " +
          lowerBoundWeight +
          " to " +
          upperBoundWeight
      )
    ...
    const ballsStandard = Number(formData.no_of_balls_standard);
    const tenPercentBalls = (ballsStandard / 100) * 10;
    const lowerBoundBalls = ballsStandard - tenPercentBalls;
    const upperBoundBalls = ballsStandard + tenPercentBalls;

    if (
      !validateField(
        formData.no_of_balls_actual,
        lowerBoundBalls,
        upperBoundBalls,
        "No. of Balls Per Bag actual should be within " +
          lowerBoundBalls +
          " to " +
          upperBoundBalls
      )
  ...
  const handleSave = async () => {
    ...
    if (role == "ROLE_CHEMIST") {
      ...
      apiurl = `${API.prodUrl}/Precot/api/QcForm/SaveCottonBallsF26B`;
      payload = {
        formatNo: "PH-QCL01/F-026B",
        revisionNo: "01",
        formatName: "CERTIFICATE OF ANALYSIS FOR COTTON BALLS",
        ...
        weight_standard: formData.weight_standard,
        weight_actual: formData.weight_actual,
        weight_remarks: formData.weight_remarks || "NA",
        no_of_balls_standard: formData.no_of_balls_standard,
        no_of_balls_actual: formData.no_of_balls_actual,
        no_of_balls_remarks: formData.no_of_balls_remarks || "NA",
      ...
      apiurl = `${API.prodUrl}/Precot/api/QcForm/ApproveOrRejectF26B`;
    ...
    if (role == "ROLE_CHEMIST") {
      ...
      const getName = (key) => {
        switch (key) {
          ...
          case "weight_actual":
            return "Weight (g/ball)";
          case "no_of_balls_standard":
          case "no_of_balls_actual":
            return "No. of Balls Per Bag";
      ...
      apiurl = `${API.prodUrl}/Precot/api/QcForm/SubmitCottonBallsF26B`;
      payload = {
        formatNo: "PH-QCL01/F-026B",
        revisionNo: "01",
        formatName: "CERTIFICATE OF ANALYSIS FOR COTTON BALLS",
  ...
  const handleBlur = (event) => {
    ...
    const twentyFivePercent = (weightStandard / 100) * 25;
    console.log("five", twentyFivePercent);
    const upperBoundWeight = weightStandard + twentyFivePercent;

    if (
      (Number(formData.weight_actual) < lowerBoundWeight ||
        Number(formData.weight_actual) > upperBoundWeight) &&
      formData.weight_actual !== "" &&
      formData.weight_standard !== ""
    ) {
      validation.add(
        "Weight (g/ball) actual should be within " +
          lowerBoundWeight +
      ...
      handleClear("weight_actual");
    }
    const ballsStandard = Number(formData.no_of_balls_standard);
    const lowerBoundBalls = ballsStandard - 0;
    const upperBoundBalls = ballsStandard + 2;

    if (
      (Number(formData.no_of_balls_actual) < lowerBoundBalls ||
        Number(formData.no_of_balls_actual) > upperBoundBalls) &&
      formData.no_of_balls_actual !== "" &&
      formData.no_of_balls_standard !== ""
    ) {
      validation.add(
        "No. of Balls Per Bag actual should be within " +
          lowerBoundBalls +
      ...
      handleClear("no_of_balls_actual");
    }
    // const grossStandard = Number(formData.gross_weight_standard);
    // const lowerBoundGross = grossStandard - 0;
    // const upperBoundGross = grossStandard + 2;
    ...
    const twentyFivePercentgross = (grossStandard / 100) * 25;
    console.log("five", twentyFivePercentgross);
    const upperBoundgross = grossStandard + twentyFivePercentgross;
  ...
  return (
    <>
      <BleachingHeader
        formName={"CERTIFICATE OF ANALYSIS FOR COTTON BALLS"}
        formatNo={"PH-QCL01/F-026B"}
        unit={"UNIT H"}
        MenuBtn={
          <Button
          ...
          <div style={{ height: "50vh" }}>
            <table style={{ height: "100%" }}>
              ...
              <tr>
                ...
                <td style={{ textAlign: "center" }}>Weight (g/ball)</td>
                <td style={{ textAlign: "center" }}>
                  ...
                  <Input
                    ...
                    value={formData.weight_standard}
                    onChange={(e) => {
                      handleInput(e.target.value, "weight_standard");
                    }}
                    onKeyDown={(e) => {
                ...
                <td style={{ textAlign: "center" }}>
                  <Input
                    ...
                    onChange={(e) => {
                      handleInput(e.target.value, "weight_actual");
                    }}
                    onKeyDown={(e) => {
                      handleDigit(e, 100, "need");
                    }}
                    readOnly={
                      status.fieldStatus || formData.weight_standard == ""
                    }
                    onBlur={handleBlur}
                  ></Input>
                </td>
                <td style={{ textAlign: "center", padding: "0px" }}>
                  <Select
                    options={Lov1}
                    value={formData.weight_remarks}
                    style={{ textAlign: "center", width: "300px" }}
                    onInputKeyDown={(e) => {
                      handleSelectText(e, "weight_remarks");
                    }}
                    onChange={(e) => {
                      handleInput(e, "weight_remarks");
                    }}
              ...
              <tr>
                ...
                <td style={{ textAlign: "center" }}>No. of Balls Per Bag</td>
                <td style={{ textAlign: "center" }}>
                  {" "}
                  <Input
                    type="number"
                    ...
                    value={formData.no_of_balls_standard}
                    onChange={(e) => {
                      handleInput(e.target.value, "no_of_balls_standard");
                    }}
                    onKeyDown={(e) => {
                      handleDigit(e, 100, "need");
                    }}
                ...
                <td style={{ textAlign: "center" }}>
                  <Input
                    ...
                    value={formData.no_of_balls_actual}
                    onChange={(e) => {
                      handleInput(e.target.value, "no_of_balls_actual");
                    }}
                    onKeyDown={(e) => {
                      handleDigit(e, 100, "no need");
                    }}
                    readOnly={
                      status.fieldStatus || formData.no_of_balls_standard == ""
                    }
                    onBlur={handleBlur}
                  ></Input>
                </td>
                <td style={{ textAlign: "center", padding: "0px" }}>
                  <Select
                    options={Lov1}
                    value={formData.no_of_balls_remarks}
                    style={{ textAlign: "center", width: "300px" }}
                    onInputKeyDown={(e) => {
                      handleSelectText(e, "no_of_balls_remarks");
                    }}
                    onChange={(e) => {
                      handleInput(e, "no_of_balls_remarks");
                    }}
                    dropdownStyle={{ textAlign: "center" }}
                    showSearch
                    filterOption={false}
              ...
              <tr>
                ...
                <td style={{ textAlign: "center" }}>
                  Gross weight of the bag with balls (g)
                </td>
                <td style={{ textAlign: "center" }}>
                  {" "}
                  <Input
              ...
              <tr>
                ...
                <td style={{ textAlign: "center" }}>
                  ...
                  <Select
                    ...
                    value={formData.fibre_specification}
                    onInputKeyDown={(e) => {
                      handleSelectText(e, "fibre_specification");
                    }}
                    onChange={(e) => {
                      handleInput(e, "fibre_specification");
                    }}
                    dropdownStyle={{ textAlign: "center" }}
                    showSearch
                    filterOption={false}
...
export default QualityControl_f26B;
