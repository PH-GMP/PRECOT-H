...
@Data
@Entity
@Table(name = "QA_COMPLAINTS_REJECT_AND_PRODUCT_RECALL_LINE_9_HISTORY", schema = AppConstants.schema)
public class ComplaintsRejectsAndProductRecallsLine9History {
	@Id
