        ...
        <Button
          ...
          style={{
            ...
            display:
              ...
              (props.loggedInQa && state.qaApproved) ||
              (state.qaApproved && state.supApproved)
                ? "none"
                : "block",
          }}
          shape="round"
          ...
          <tr>
            ...
            <td style={{ padding: "1em" }} align="center">
              ...
              className="inp-new"
                ...
                disabled={state.qaApproved || !props.loggedInQa}
              />
            </td>
            <td>
              <Radio.Group
                onChange={(e) =>
                  updateState({
                    freetextRemarks: e.target.value,
                  })
                }
                value={state.freetextRemarks}
                disabled={state.qaApproved || !props.loggedInQa}
              >
                <Radio value="ATTACHED">Attached</Radio>
                <Radio value="NOT ATTACHED">Not Attached</Radio>
