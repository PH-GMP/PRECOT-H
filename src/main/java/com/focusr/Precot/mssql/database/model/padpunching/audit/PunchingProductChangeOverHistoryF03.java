...
@Data
@Entity
@Table(name = "PUNCHING_PROD_CHANGE_OVER_HISTORY_F03",schema=AppConstants.schema)
public class PunchingProductChangeOverHistoryF03 extends SpunlaceSaveSubmitQA {
