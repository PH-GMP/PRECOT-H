...
@Data
@Entity
@Table(name = "SHIFT_WISE_STOPPAGE_REPORT_F018", schema = AppConstants.schema, uniqueConstraints = {
		@UniqueConstraint(columnNames = "DATE") })

public class SpunlaceShiftWiseStoppageReportF018 extends UserDateAudit {
