...
@Data
@Entity
@Table(name = "BLEACH_HOUSE_KEEP_CLEAN_CHECK_LIST_HISTORY_F02A", schema=AppConstants.schema)
public class BleachHouseKeepingCheckListHistoryF02A extends UserDateAudit{
