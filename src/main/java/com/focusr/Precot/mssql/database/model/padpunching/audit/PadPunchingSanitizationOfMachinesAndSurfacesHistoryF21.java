...
@Data
@Entity
@Table(name = "PADPUNCHING_SANITIZATION_OF_MACHINES_AND_SURFACES_HISTORY_F21", schema = AppConstants.schema)
public class PadPunchingSanitizationOfMachinesAndSurfacesHistoryF21 extends SpunlaceSaveSumbitSupervisor{
