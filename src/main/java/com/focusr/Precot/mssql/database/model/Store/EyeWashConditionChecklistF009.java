...
@Entity
@Table(name = "STORE_EYE_WASH_SHOWER_WORKING_CONDITION_CHECKLIST_F009",schema = AppConstants.schema, uniqueConstraints = {
        @UniqueConstraint(columnNames = {"DATE"})
})
@Data
public class EyeWashConditionChecklistF009  extends UserDateAudit{
