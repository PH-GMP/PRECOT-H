...
@Data
@Entity
@Table(name = "BLEACH_MACHINE_CLEANING_RECORD_F16", schema = AppConstants.schema, uniqueConstraints = {
		@UniqueConstraint(columnNames = { "DATE", "MONTH", "YEAR" }) })
public class BleachMachineCleaningRecordF16 extends UserDateAudit {
