...
const Bleaching_f38_hod_summary = () => {
  ...
  {/* <div id="section-to-print">
      {printresponseData.map((item, index) => (
        <table style={{marginTop:"2%", width:'90%'}}>
                ...
                <tr>
            <td colSpan="1" rowSpan="6"style={{ height: "30px", textAlign: "center" }}>
        ...
        <tr>
          <td colSpan="10">  Mixing change over from :  {item.mix_changeover_from}
 </td>
                <td colSpan="10">
              ...
              <tr>
                <td colSpan="10">
                  BMR No From :{item.bmr_no_from}
                </td>
                <td colSpan="10">
                  BMR No To :{item.bmr_no_to}
                </td>
              </tr>
              <tr>
                <td style={{ fontWeight: "bold",textAlign:'center'  }} colSpan="1">
                  S.No.
                </td>
                <td style={{ fontWeight: "bold" ,textAlign:'center' }} colSpan="5">
                  Particular's
                </td>
                <td style={{ fontWeight: "bold",textAlign:'center'  }} colSpan="3" >
                  Status
                </td>
                <td style={{ fontWeight: "bold",textAlign:'center'  }} colSpan="2">
                  S.No.
                </td>
                <td style={{ fontWeight: "bold" ,textAlign:'center' }} colSpan="8">
                  Particular's
                </td>
                <td style={{ fontWeight: "bold",textAlign:'center'  }} colSpan="1">
                  Status
              ...
              <tr>
                ...
                <td colSpan="3"style={{ textAlign:"center" }}>{item.laydown_area_cleaning}</td>
                <td colSpan="2"style={{ textAlign:"center" }}>15</td>
                <td colSpan="8">Cake Press Machine 1 & 2 Cleaning</td>
                <td colSpan="1"style={{ textAlign:"center" }}>{item.cake_opener_clean}</td>
              </tr>
              <tr>
                <td colSpan="1"style={{ textAlign:"center" }}>2</td>
                <td colSpan="5">Blendomat cleaning</td>
                <td colSpan="4"style={{ textAlign:"center" }}>{item.blendomat_cleaning}</td>
                <td colSpan="1"style={{ textAlign:"center" }}>16</td>
                <td colSpan="5">
                  Kier machine unit Machine 1, 2 & 3 cleaning & Chemical
                  dispenser Cleaning
                </td>
                <td colSpan="4"style={{ textAlign:"center" }}>{item.kier_machine_chemical_clean}</td>
              </tr>
              <tr>
                <td colSpan="1"style={{ textAlign:"center" }}>3</td>
                <td colSpan="5">BRF 425 cleaning</td>
                <td colSpan="4"style={{ textAlign:"center" }}>{item.brf_425_unit}</td>
               ...
               {item.chemical_buckets_chemical_weighing_balance_cleaning}</td>
              </tr>
              <tr>
                <td colSpan="1"style={{ textAlign:"center" }}>4</td>
                <td colSpan="5">Fire divertor cleaning</td>
                <td colSpan="4"style={{ textAlign:"center" }}>{item.fire_diverotor_cleaning}</td>
                <td colSpan="1"style={{ textAlign:"center" }}>18</td>
                <td colSpan="5">Hydro Machine 1 & 2 Cleaning</td>
                <td colSpan="4"style={{ textAlign:"center" }}>{item.hydro_machine_cleaning}</td>
              </tr>
 
              <tr>
                <td colSpan="1"style={{ textAlign:"center" }}>5</td>
                <td colSpan="5">Metal Detector Cleaning</td>
                <td colSpan="4"style={{ textAlign:"center" }}>{item.metal_fire_detector}</td>
                <td colSpan="1"style={{ textAlign:"center" }}>19</td>
                <td colSpan="5">Cake Opener Cleaning</td>
                <td colSpan="4"style={{ textAlign:"center" }}>{item.cake_opener_clean}</td>
              </tr>
              <tr>
                <td colSpan="1"style={{ textAlign:"center" }}>6</td>
                <td colSpan="5">CL - P Unit 1 & 2 Cleaning</td>
                <td colSpan="4"style={{ textAlign:"center" }}>{item.clp_unit_cleaning}</td>
                <td colSpan="1"style={{ textAlign:"center" }}>20</td>
                <td colSpan="5">Dryer cleaning (6 Chamber Filters)</td>
                <td colSpan="4"style={{ textAlign:"center" }}>{item.dryer_cleaning}</td>
              </tr>
              <tr>
                <td colSpan="1"style={{ textAlign:"center" }}>7</td>
                <td colSpan="5">BRF - 425 Cleaning 1 & 2 Cleaning</td>
                <td colSpan="4"style={{ textAlign:"center" }}>{item.brf_425_cleaning}</td>
                <td colSpan="1"style={{ textAlign:"center" }}>21</td>
                <td colSpan="5">MTF Unit cleaning</td>
                <td colSpan="4"style={{ textAlign:"center" }}>{item.mtf_unit_clean}</td>
              </tr>
              <tr>
                <td colSpan="1"style={{ textAlign:"center" }}>8</td>
                <td colSpan="5">MPM Unit 1 & 2 Cleaning</td>
                <td colSpan="4"style={{ textAlign:"center" }}>{item.mpm_unit_cleaning}</td>
                <td colSpan="1"style={{ textAlign:"center" }}>22</td>
                <td colSpan="5">Rieter 1 & 2 Cleaning</td>
                <td colSpan="4"style={{ textAlign:"center" }}>{item.rieter_clean}</td>
              </tr>
              <tr>
                <td colSpan="1"style={{ textAlign:"center" }}>9</td>
                <td colSpan="5">Applied unit 1 & 2 Cleaning</td>
                <td colSpan="4"style={{ textAlign:"center" }}>{item.applied_unit_cleaning_one}</td>
                <td colSpan="1"style={{ textAlign:"center" }}>23</td>
                <td colSpan="5">Applied unit 1 & 2 Cleaning</td>
                <td colSpan="4"style={{ textAlign:"center" }}>{item.applied_unit_cleaning_two}</td>
              </tr>
              <tr>
                <td colSpan="1"style={{ textAlign:"center" }}>10</td>
                <td colSpan="5">ERM Unit 1&2 Cleaning</td>
                <td colSpan="4"style={{ textAlign:"center" }}>{item.erm_unit_cleaning}</td>
                <td colSpan="1"style={{ textAlign:"center" }}>24</td>
              ...
              <tr>
                ...
                <td colSpan="4"style={{ textAlign:"center" }}>{item.ccp_unit_cleaning}</td>
                <td colSpan="1"style={{ textAlign:"center" }}>25</td>
                <td colSpan="5">Bale Press condensor & Conveyor Cleaning</td>
                <td colSpan="4"style={{ textAlign:"center" }}>{item.balepress_conveyor_cleaning}</td>
              </tr>
              <tr>
                <td colSpan="1"style={{ textAlign:"center" }}>12</td>
                <td colSpan="5">Dustex Unit 1& 2 Cleaning</td>
                <td colSpan="4"style={{ textAlign:"center" }}>{item.dustex_unit_cleaning}</td>
 
                <td colSpan="1"style={{ textAlign:"center" }}>26</td>
                <td colSpan="5">Bale Press Strapper machine Cleaning</td>
                <td colSpan="4"style={{ textAlign:"center" }}>{item.balepress_stapper_mechine_cleaning}</td>
              </tr>
              <tr>
                <td colSpan="1"style={{ textAlign:"center" }}>13</td>
                <td colSpan="5">Carding Machins (1 to 6) Cleaning</td>
                <td colSpan="4"style={{ textAlign:"center" }}>{item.carding_machines_cleaning}</td>
                <td colSpan="1"style={{ textAlign:"center" }}>27</td>
              ...
              <tr>
                ...
                <td colSpan="4"style={{ textAlign:"center" }}>{item.hennatex_condenser_unit}</td>
                <td colSpan="1"style={{ textAlign:"center" }}>28</td>
 
                <td colSpan="5">Bale Storage floor Cleaning</td>
                <td colSpan="4"style={{ textAlign:"center" }}>{item.bake_storage_floor_cleaning}</td>
              </tr>
...
export default Bleaching_f38_hod_summary;