...
@Data
@Entity
@Table(name = "QA_MANAGEMENT_OF_INCIDENCE", schema = AppConstants.schema, uniqueConstraints = {
		@UniqueConstraint(columnNames = { "YEAR", "MONTH", "DATE" }) })
public class ManagementOfIncidence extends UserDateAudit {
	@Id
