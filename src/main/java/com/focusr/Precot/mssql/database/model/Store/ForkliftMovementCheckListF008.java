...
@Entity
@Table(name = "STORE_FORKLIFT_MOVEMENT_CHECKLIST_F008",schema = AppConstants.schema, uniqueConstraints = {
        @UniqueConstraint(columnNames = {"FORK_LIFT_NO","DATE"})
})
@Data
public class ForkliftMovementCheckListF008 extends UserDateAudit {
