...
@Data
@Entity
@Table(name = "PADPUNCHING_BAGMAKING_DAILYPRODUCTION_DETAILS_HISOTY_F001", schema = AppConstants.schema)
public class PadPunchingBagMakingDailyProductionDetailsHistoryF001 extends SaveSubmitOperatorHod{
