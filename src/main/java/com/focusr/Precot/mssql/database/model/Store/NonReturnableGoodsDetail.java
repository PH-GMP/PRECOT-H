...
@Entity
@Table(name = "STORE_NON_RETURNABLE_GATE_PASS_GOODS_DETAIL_F006",schema = AppConstants.schema)
public class NonReturnableGoodsDetail {
    ...
    @JsonIgnore
    private NonReturnableGatePassF006 gatePass;
	...
	public NonReturnableGatePassF006 getGatePass() {
		return gatePass;
	}

	public void setGatePass(NonReturnableGatePassF006 gatePass) {
