...
public class BudsBmrSummaryController {
	...
	public ResponseEntity<?> submitPostProductionReview(
			@Valid @RequestBody BudsBmrPostProductionReview postProductionReview, HttpServletRequest http) {
	...
	public ResponseEntity<?> submitProductRelease(@Valid @RequestBody BudsBmrProductRelease productRelease,
	...
	public ResponseEntity<?> submitMaufacturerSteps(
			@Valid @RequestBody BudsBmrManufacturerStepsHeader manufacturerSteps, HttpServletRequest http) {
	...
	public ResponseEntity<?> saveEnclosureList(@Valid @RequestBody BudsBmrEnclosureListHeader enclosureList,
			HttpServletRequest http) {
	...
	public ResponseEntity<?> saveQualityRelease(@Valid @RequestBody BudsBmrQualityReleaseHeader qualityRelease,
			HttpServletRequest http) {
	...
	public ResponseEntity<?> submitQualityRelease(@Valid @RequestBody BudsBmrQualityReleaseHeader qualityRelease,
			HttpServletRequest http) {
	...
	public ResponseEntity<?> getStoppageList(@RequestParam Map<String, String> requestParams, Principal principal) {
	...
	public ResponseEntity<?> getSAPData(@RequestParam Map<String, String> requestParams, Principal principal) {
	...
	public ResponseEntity<?> approveReworkForm(@Valid @RequestBody ApproveResponse approveResponse,
			HttpServletRequest http) {
	...
	public ResponseEntity<?> reworkFormByBatchNo(@RequestParam Map<String, String> requestParams, Principal principal) {
	...
	public ResponseEntity<?> budsBmrPrint(@RequestParam Map<String, String> requestParams, Principal principal) {
...
//	}
	...
	@GetMapping("/julian")
	public ResponseEntity<?> budsTraceability(@RequestParam Map<String, String> requestParams, Principal principal) {
	...
	public ResponseEntity<?> traceablity(@RequestParam Map<String, String> requestParams, Principal principal) {
	...
	public ResponseEntity<?> budsTrace(@RequestParam Map<String, String> requestParams, Principal principal) {
