...
@Entity
@Table(name = "BUDS_BMR_PROCESS_DEVIATION_RECORD_LINE", schema = AppConstants.schema)
public class BudsBmrProcessDeviationRecordLine extends UserDateAudit {
	...
	@JsonIgnore
	private BudsBmrProcessDeviationRecordHeader deviationRecord;
	...
	public BudsBmrProcessDeviationRecordHeader getDeviationRecord() {
		return deviationRecord;
	}

	public void setDeviationRecord(BudsBmrProcessDeviationRecordHeader deviationRecord) {
