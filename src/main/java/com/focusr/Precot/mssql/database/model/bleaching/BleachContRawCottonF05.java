...
@Entity
@Table(name = "BLEACH_CONT_RAWCOTTON_F05",schema=AppConstants.schema, uniqueConstraints = {
		@UniqueConstraint(columnNames = { "PH_NO" }) })
public class BleachContRawCottonF05 extends UserDateAudit
{
	@Id
   ...
   @Column(name = "SUPERVISOR_STATUS")
	...
	public BleachContRawCottonF05() {
	}

	
	public BleachContRawCottonF05(Long id, String formatName, String formatNo, Long revisionNo, String refSopNo,
			String date, String phNo, Float quantity, String supplierName, Long noOfHair, String refHair, Long noOfJute,
			String refJute, Long noOfColourThread, String refColourThread, Long noOfWrapper, String refWrapper,
			Long noOfMetal, String refMetal, Long noOfRust, String refRust, Long noOfPlastic, String refPlastic,
			Long noOfBlackCotton, String refBlackCotton, Long noOfOilCotton, String refOilCotton, Long noOfSoil,
			String refSoil, Long noOfYellowCotton, String refYellowCotton, Long noOfPaper, String refPaper,
			Long noOfStick, String refStick, Long noOfFeather, String refFeather, Long noOfCloth, String refCloth,
	...
	public String toString() {
		return "BleachContRawCottonF05 [id=" + id + ", formatName=" + formatName + ", formatNo=" + formatNo
				+ ", revisionNo=" + revisionNo + ", refSopNo=" + refSopNo + ", date=" + date + ", phNo=" + phNo
				+ ", quantity=" + quantity + ", supplierName=" + supplierName + ", noOfHair=" + noOfHair + ", refHair="
				+ refHair + ", noOfJute=" + noOfJute + ", refJute=" + refJute + ", noOfColourThread=" + noOfColourThread
				+ ", refColourThread=" + refColourThread + ", noOfWrapper=" + noOfWrapper + ", refWrapper=" + refWrapper
				+ ", noOfMetal=" + noOfMetal + ", refMetal=" + refMetal + ", noOfRust=" + noOfRust + ", refRust="
				+ refRust + ", noOfPlastic=" + noOfPlastic + ", refPlastic=" + refPlastic + ", noOfBlackCotton="
				+ noOfBlackCotton + ", refBlackCotton=" + refBlackCotton + ", noOfOilCotton=" + noOfOilCotton
				+ ", refOilCotton=" + refOilCotton + ", noOfSoil=" + noOfSoil + ", refSoil=" + refSoil
				+ ", noOfYellowCotton=" + noOfYellowCotton + ", refYellowCotton=" + refYellowCotton + ", noOfPaper="
				+ noOfPaper + ", refPaper=" + refPaper + ", noOfStick=" + noOfStick + ", refStick=" + refStick
				+ ", noOfFeather=" + noOfFeather + ", refFeather=" + refFeather + ", noOfCloth=" + noOfCloth
				+ ", refCloth=" + refCloth + ", noOfwhitePolyPropylene=" + noOfwhitePolyPropylene
				+ ", refWhitePolyPropylene=" + refWhitePolyPropylene + ", noOfColourPolyPropylene="
				+ noOfColourPolyPropylene + ", refColourPolyPropylene=" + refColourPolyPropylene + ", noOfRubberPiece="
				+ noOfRubberPiece + ", refRubberPiece=" + refRubberPiece + ", total=" + total + ", refTotal=" + refTotal
				+ ", unit=" + unit + ", mail_status=" + mail_status + ", supervisor_status=" + supervisor_status
				...
				+ ", supervisor_sign=" + supervisor_sign + ", hod_status=" + hod_status + ", hod_saved_on="
				+ hod_saved_on + ", hod_saved_by=" + hod_saved_by + ", hod_saved_id=" + hod_saved_id
