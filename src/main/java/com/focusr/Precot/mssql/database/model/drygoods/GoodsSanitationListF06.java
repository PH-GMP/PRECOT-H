...
@Entity
@Table(name = "GOODS_SANITIZATION_LIST_F24",schema=AppConstants.schema)
public class GoodsSanitationListF06 extends UserDateAudit{
	...
	@ManyToOne
    @JoinColumn(name = "HAND_SANITIZATION_ID", nullable = false)
	@JsonIgnore
    private GoodsHandSanitationF06 details;
...
//	private Long handSanitizationId;
	...
	public GoodsHandSanitationF06 getDetails() {
		return details;
	}

	public void setDetails(GoodsHandSanitationF06 details) {
