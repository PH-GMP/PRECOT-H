...
@Data
@Entity
@Table(name = "SPECTROPHOTOMETR_REPORT", schema = AppConstants.schema, uniqueConstraints = {
		@UniqueConstraint(columnNames = { "YEAR","MONTH" , "EQ_ID_NO"}) })
public class spectrophotometerReportClF011 extends UserDateAudit {
