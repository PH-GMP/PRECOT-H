...
function ContaminationCheckReportEdit(props) {
        ...
        <div>
          <table>
            <tbody>
              ...
              <tr >
                <td colSpan="1" style={{ Width: '99px', height: '35px' }}>Sr.No</td>
        ...
        <div>
          <table>
            <tbody>
              ...
              <tr>
                <td colSpan="1">16</td>
                <td colSpan="4">White Polythene</td>
                <td colSpan="5"><input
                  className="inp-new"
              ...
              <tr>
                <td colSpan="1">17</td>
                <td colSpan="4">Color Polythene</td>
                <td colSpan="5"><input
                  className="inp-new"
...
export default ContaminationCheckReportEdit;