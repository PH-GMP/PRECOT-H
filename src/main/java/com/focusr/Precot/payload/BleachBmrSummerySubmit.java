...
@JsonIgnoreProperties(value = { "supervisor_status", "supervisor_save_on", "supervisor_save_by", "supervisor_save_id",
		"supervisor_submit_on", "supervisor_submit_by", "supervisor_submit_id", "supervisor_sign", "qa_status",
		"qa_save_on", "qa_save_by", "qa_save_id", "qa_submit_on", "qa_submit_by", "qa_submit_id", "qa_mail_status",
		"qa_sign", "supervisor_signature_image", "hod_signature_image",
		"qa_signature_image" }, allowGetters = true, allowSetters = true)
public class BleachBmrSummerySubmit extends UserDateAudit {
