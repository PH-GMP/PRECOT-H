...
const QualityControl_f26B_Summary = () => {
  ...
  const productLovApiPrint = async (value, type) => {
    try {
      const response = await axios.get(
        `${API.prodUrl}/Precot/api/QcForm/ProductF26?customer=${value}&formNo=F26B`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleOk = () => {
    ...
    navigate(`/Precot/QualityControl/F-026B`, {
      state: {
  ...
  const handlePrint = async () => {
    ...
    try {
      const response = await axios.get(
        `${API.prodUrl}/Precot/api/QcForm/PrintApiF26B?product=${printParams.productName}&customer=${printParams.customerName}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  #section-to-print-san table td {
    ...
    `}
        ...
        <div className="page-break">
          <table style={{ borderCollapse: "collapse", width: "100%" }}>
            ...
            <tr>
              ...
              <td
                ...
                rowSpan={4}
              >
                CERTIFICATE OF ANALYSIS FOR COTTON BALLS
              </td>
              <td style={{ padding: "0.5em" }}>Format No.:</td>
              <td style={{ padding: "0.5em" }}>PH-QCL01/F-026B</td>
            </tr>
            <tr>
          ...
          <table style={{ height: "100%" }}>
            ...
            <tr>
              ...
              <td style={{ textAlign: "left" }}>Weight (g/ball)</td>
              <td style={{ textAlign: "center" }}>
                {printData.weight_standard}
              </td>
              <td style={{ textAlign: "center" }}>± 10%</td>
              <td style={{ textAlign: "center" }}>{printData.weight_actual}</td>
              <td style={{ textAlign: "center", padding: "0px" }}>
                {printData.weight_remarks}
              </td>
            </tr>
            <tr>
              <td style={{ textAlign: "center" }}> 2 </td>
              <td style={{ textAlign: "left" }}>No. of Balls Per Bag</td>
              <td style={{ textAlign: "center" }}>
                {printData.no_of_balls_standard}
              </td>
              <td style={{ textAlign: "center" }}>± 10 %</td>
              <td style={{ textAlign: "center" }}>
                {printData.no_of_balls_actual}
              </td>
              <td style={{ textAlign: "center", padding: "0px" }}>
                {printData.no_of_balls_remarks}
              </td>
            </tr>
            <tr>
      ...
      />
      <Modal
        title="COA FOR COTTON BALLS (Print)"
        open={isModalPrint}
...
export default QualityControl_f26B_Summary;
