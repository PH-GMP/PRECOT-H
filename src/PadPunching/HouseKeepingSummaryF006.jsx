...
const HouseKeepingSummary1 = () => {
    ...
    const [formName, setFormName] = useState("House Keeping Cleaning Check List (Pad Punching)");
...
`;
    ...
    useEffect(() => {
        const fetchData = () => {
            ...
            axios.get(`${ API.prodUrl}/Precot/api/PadPunching/Service/getHouseKeepingSummeryF26`, {
                    ...
                    <tbody>
                        <tr style={{ width: "80%" }}>
                            <th
                                colSpan="10"
                                rowSpan="4"
                                printDateSubmit style={{ textAlign: "center", height: "80px" }}
                            >
                                <img
                                    src={logo}
                                    alt="Logo"
