...
const Product_Reconciliation = (props) => {
  ...
  const handleSubmit = async () => {
    const params = {
      ...
      order_no: "ORDER456", // Replace with dynamic value if required
      form_no: "Balls", // Fixed value for form_no
    ...
    try {
      const response = await axios.post(
        `${API.prodUrl}/Precot/api/cottonBall/SubmitProductReconillation`,
        params,
        {
          headers: {
