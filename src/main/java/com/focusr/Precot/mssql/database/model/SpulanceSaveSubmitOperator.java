...
@JsonIgnoreProperties(value = { "operator_status", "operator_save_by", "operator_save_on", "operator_save_id",
		"operator_submitted_by", "operator_submitted_on", "operator_submitted_id", "operator_sign", "supervisor_status",
		"supervisor_save_on", "supervisor_save_by", "supervisor_save_id", "supervisor_submit_on",
		"supervisor_submit_by", "supervisor_submit_id", "supervisor_sign", "supervisior_mail_status", "hod_status",
		"hod_save_on", "hod_save_by", "hod_save_id", "hod_submit_on", "hod_submit_by", "hod_submit_id",
		"hod_sign","hod_mail_status","hod_signature_image","supervisor_signature_image","operator_signature_image" }, allowGetters = true, allowSetters = true)
public abstract class SpulanceSaveSubmitOperator extends UserDateAudit {
