...
@Data
@Entity
@Table(name = "PADPUNCHING_LOG_BOOK_BAG_MAKING_F003", schema = AppConstants.schema, uniqueConstraints = {
		@UniqueConstraint(columnNames = {"DATE","SHIFT" }) })
public class PadPunchingLogBookBagMakingF003 extends SaveSubmitOperatorHod{
