...
@Data
@Entity
@Table(name = "QC_VALIDATION_FOR_AUTOCLAVE_BY_CHEMICAL_INDICATORF014", schema = AppConstants.schema, uniqueConstraints = {
		@UniqueConstraint(columnNames = { "EQ_ID","DATE"}) } )
public class Qc_ValidationForAutoclaveByChemicalIndicatorF014 extends UserDateAudit {
	...
	@Column(name = "CHEMICAL_INDICATOR_STRIP")
	private String chemicalIndicatorStrip;
