...
@Data
@Entity
@Table(name = "BATCH_RELEASE_CHECKLIST", schema = AppConstants.schema, uniqueConstraints = {
		@UniqueConstraint(columnNames = { "BMR_NO" , "department"}) })
public class batchReleaseChecklist extends DateAudit {
