...
const Verification_Of_Records = (props) => {
  ...
  useEffect(() => {
    ...
    if (props.batchNo.length > 0) {
      axios
        .get(
          `${API.prodUrl}/Precot/api/cottonBall/06.GetVerificationOfRecords?batch_no=${props.batchNo}`,
          {
            headers: {
  ...
  const saveVerificationRecords = async () => {
    ...
    const payload = {
      ...
      detailsVerificationRecords: [
        {
          // verification_id: "",
          checked_date: verificationRecords.CheckedByDate1 || supervisorDate,
          checked_time: "",
          checked_name: "" || usernameSupervisor,
          checked_sign:
            verificationRecords.CheckedBySign1 || usernameSupervisor,
          verified_date: verificationRecords.VerifiedByDate1 || qaDate,
          verified_time: "",
          verified_name: "" || username,
          verified_sign: verificationRecords.VerifiedBySign1 || username,
          activity: verificationRecords.houseKeepingCleaningStatus,
          name_of_record: "Observation1",
        },
        {
          // verification_id: "",
          checked_date: verificationRecords.CheckedByDate2 || supervisorDate,
          checked_time: "",
          checked_name: "" || usernameSupervisor,
          checked_sign:
            verificationRecords.CheckedBySign2 || usernameSupervisor,
          verified_date: verificationRecords.VerifiedByDate2 || qaDate,
          verified_time: "",
          verified_name: "" || username,
          verified_sign: verificationRecords.VerifiedBySign2 || username,
          activity: verificationRecords.machineCleaningRecordStatus,
          name_of_record: "Observation2",
        },
        {
          // verification_id: "",
          checked_date: verificationRecords.CheckedByDate3 || supervisorDate,
          checked_time: "",
          checked_name: "" || usernameSupervisor,
          checked_sign:
            verificationRecords.CheckedBySign3 || usernameSupervisor,
          verified_date: verificationRecords.VerifiedByDate3 || qaDate,
          verified_time: "",
          verified_name: "" || username,
          verified_sign: verificationRecords.VerifiedBySign3 || username,
          activity: verificationRecords.logbookStatus,
          name_of_record: "Observation3",
        },
        {
          // verification_id: "",
          checked_date: verificationRecords.CheckedByDate4 || supervisorDate,
          checked_time: "",
          checked_name: "" || usernameSupervisor,
          checked_sign:
            verificationRecords.CheckedBySign4 || usernameSupervisor,
          verified_date: verificationRecords.VerifiedByDate4 || qaDate,
          verified_time: "",
          verified_name: "" || username,
          verified_sign: verificationRecords.VerifiedBySign4 || username,
          activity: verificationRecords.productionRecordStatus,
          name_of_record: "Observation4",
        },
        {
          // verification_id: "",
          checked_date: verificationRecords.CheckedByDate5 || supervisorDate,
          checked_time: "",
          checked_name: "" || usernameSupervisor,
          checked_sign:
            verificationRecords.CheckedBySign5 || usernameSupervisor,
          verified_date: verificationRecords.VerifiedByDate5 || qaDate,
          verified_time: "",
          verified_name: "" || username,
          verified_sign: verificationRecords.VerifiedBySign5 || username,
          activity: verificationRecords.baleConsumptionRecordStatus,
          name_of_record: "Observation5",
        },
        {
          // verification_id: "",
          checked_date: verificationRecords.CheckedByDate6 || supervisorDate,
          checked_time: "",
          checked_name: "" || usernameSupervisor,
          checked_sign:
            verificationRecords.CheckedBySign6 || usernameSupervisor,
          verified_date: verificationRecords.VerifiedByDate6 || qaDate,
          verified_time: "",
          verified_name: "" || username,
          verified_sign: verificationRecords.VerifiedBySign6 || username,
          activity: verificationRecords.productChangeOverStatus,
          name_of_record: "Observation6",
        },
        {
          // verification_id: "",
          checked_date: verificationRecords.CheckedByDate7 || supervisorDate,
          checked_time: "",
          checked_name: "" || usernameSupervisor,
          checked_sign:
            verificationRecords.CheckedBySign7 || usernameSupervisor,
          verified_date: verificationRecords.VerifiedByDate7 || qaDate,
          verified_time: "",
          verified_name: "" || username,
          verified_sign: verificationRecords.VerifiedBySign7 || username,
          activity: verificationRecords.sharpToolIssueRecordStatus,
          name_of_record: "Observation7",
        },
        {
          // verification_id: "",
          checked_date: verificationRecords.CheckedByDate8 || supervisorDate,
          checked_time: "",
          checked_name: "" || usernameSupervisor,
          checked_sign:
            verificationRecords.CheckedBySign8 || usernameSupervisor,
          verified_date: verificationRecords.VerifiedByDate8 || qaDate,
          verified_time: "",
          verified_name: "" || username,
          verified_sign: verificationRecords.VerifiedBySign8 || username,
    ...
    axios
      .post(
        `${API.prodUrl}/Precot/api/cottonBall/06.SaveVerificationOfRecords`,
  ...
  const submitVerificationRecords = async () => {
    ...
    if (props.loggedInQa) {
      ...
      axios
        .post(
          `${API.prodUrl}/Precot/api/cottonBall/06.SubmitVerificationOfRecords`,
          newSave ? payload_2 : payload,
          {
            headers: {
              Authorization: `Bearer ${localStorage.getItem("token")}`,
    ...
    <div>
      <>
        ...
        >
          ...
          <tr>
            ...
            <td colSpan="3">
              ...
              <Input
                ...
                value={verificationRecords.CheckedByDate1 || supervisorDate}
                disabled={!props.loggedInSupervisor || supervisorApproved}
                max={todayDateTime}
              />
            </td>
            <td colSpan="3">
              ...
              <Input
                ...
                value={verificationRecords.VerifiedByDate1 || qaDate}
                disabled={
                  !props.loggedInQa ||
                  qaApproved ||
                  (!supervisorApproved && props.loggedInQa)
          ...
          <tr>
            ...
            <td colSpan="3">
              ...
              <Input
                ...
                value={verificationRecords.CheckedByDate2 || supervisorDate}
                disabled={!props.loggedInSupervisor || supervisorApproved}
                max={todayDateTime}
              />
            </td>
            <td colSpan="3">
              ...
              <Input
                ...
                value={verificationRecords.VerifiedByDate2 || qaDate}
                disabled={
                  !props.loggedInQa ||
                  qaApproved ||
                  (!supervisorApproved && props.loggedInQa)
          ...
          <tr>
            ...
            <td colSpan="3">
              ...
              <Input
                ...
                value={verificationRecords.CheckedByDate3 || supervisorDate}
                disabled={!props.loggedInSupervisor || supervisorApproved}
                max={todayDateTime}
              />
            </td>
            <td colSpan="3">
              ...
              <Input
                ...
                value={verificationRecords.VerifiedByDate3 || qaDate}
                disabled={
                  !props.loggedInQa ||
                  qaApproved ||
                  (!supervisorApproved && props.loggedInQa)
          ...
          <tr>
            ...
            <td colSpan="3">
              ...
              <Input
                ...
                value={verificationRecords.CheckedByDate4 || supervisorDate}
                disabled={!props.loggedInSupervisor || supervisorApproved}
                max={todayDateTime}
              />
            </td>
            <td colSpan="3">
              ...
              <Input
                ...
                value={verificationRecords.VerifiedByDate4 || qaDate}
                disabled={
                  !props.loggedInQa ||
                  qaApproved ||
                  (!supervisorApproved && props.loggedInQa)
          ...
          <tr>
            <td colSpan="3" style={{ padding: "1em" }}>
              <b>Bale consumption for Sliver Record </b>
            </td>
            <td colSpan="3">
              <Select
                options={props.supLov}
              ...
              <Input
                ...
                value={verificationRecords.CheckedByDate5 || supervisorDate}
                disabled={!props.loggedInSupervisor || supervisorApproved}
                max={todayDateTime}
              />
            </td>
            <td colSpan="3">
              ...
              <Input
                ...
                value={verificationRecords.VerifiedByDate5 || qaDate}
                disabled={
                  !props.loggedInQa ||
                  qaApproved ||
                  (!supervisorApproved && props.loggedInQa)
          ...
          <tr>
            ...
            <td colSpan="3">
              ...
              <Input
                ...
                value={verificationRecords.CheckedByDate6 || supervisorDate}
                disabled={!props.loggedInSupervisor || supervisorApproved}
                max={todayDateTime}
              />
            </td>
            <td colSpan="3">
              ...
              <Input
                ...
                value={verificationRecords.VerifiedByDate6 || qaDate}
                disabled={
                  !props.loggedInQa ||
                  qaApproved ||
                  (!supervisorApproved && props.loggedInQa)
          ...
          <tr>
            ...
            <td colSpan="3">
              ...
              <Input
                ...
                value={verificationRecords.CheckedByDate7 || supervisorDate}
                disabled={!props.loggedInSupervisor || supervisorApproved}
                max={todayDateTime}
              />
            </td>
            <td colSpan="3">
              ...
              <Input
                ...
                value={verificationRecords.VerifiedByDate7 || qaDate}
                disabled={
                  !props.loggedInQa ||
                  qaApproved ||
                  (!supervisorApproved && props.loggedInQa)
          ...
          <tr>
            ...
            <td colSpan="3">
              ...
              <Input
                ...
                value={verificationRecords.CheckedByDate8 || supervisorDate}
                disabled={!props.loggedInSupervisor || supervisorApproved}
                max={todayDateTime}
              />
            </td>
            <td colSpan="3">
              ...
              <Input
                ...
                value={verificationRecords.VerifiedByDate8 || qaDate}
                disabled={
                  !props.loggedInQa ||
                  qaApproved ||
                  (!supervisorApproved && props.loggedInQa)
