...
const QualityControl_f26_Summary = () => {
  ...
  useEffect(() => {
    if (!initialized.current) {
      ...
      const fetchData = async () => {
        try {
          const response = await axios.get(
            `${API.prodUrl}/Precot/api/QcForm/AbCottonSummary`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
  ...
  const handleOk = () => {
    ...
    navigate(`/Precot/QualityControl/F-026`, {
      state: {
  ...
  const handlePrint = async () => {
    ...
    try {
      const response = await axios.get(
        `${API.prodUrl}/Precot/api/QcForm/PrintApi?product=${printParams.productName}&customer=${printParams.customerName}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        ...
        <div className="page-break">
          <table style={{ borderCollapse: "collapse", width: "100%" }}>
            ...
            <tr>
              ...
              <td
                ...
                rowSpan={4}
              >
                CERTIFICATE OF ANALYSIS FOR ABSORBENT BLEACHED COTTON
              </td>
              <td style={{ padding: "0.5em" }}>Format No.:</td>
              <td style={{ padding: "0.5em" }}>PH-QCL01/F-026</td>
            </tr>
            <tr>
          ...
          <table style={{ height: "100%" }}>
            ...
            <tr>
              ...
              <td colSpan={3}>{printData.raw_material}</td>
            </tr>
            <tr>
            ...
            <tr>
              <td colSpan={3}>Production Date </td>
              <td colSpan={3}>{formatDate(printData.production_date)}</td>
            </tr>
            <tr>
              <td colSpan={3}>Bale No. / Batch no. </td>
              <td colSpan={3}>{printData.bale_no}</td>
            </tr>
            <tr>
              ...
              <th style={{ textAlign: "center" }}>
                {" "}
                Actual/ <br /> Observation{" "}
              </th>
              <th style={{ textAlign: "center" }}>Remark</th>
            </tr>
            <tr>
              <td style={{ textAlign: "center" }}> 1 </td>
              <td style={{ textAlign: "left" }}>Bale Weight (Kg)</td>
              <td style={{ textAlign: "center" }}>150.0</td>
              <td style={{ textAlign: "center" }}>±15</td>
              <td style={{ textAlign: "center" }}> {printData.bale_actual}</td>
              <td style={{ textAlign: "center", padding: "0px" }}>
                {printData.bale_remarks}
              </td>
            </tr>
            <tr>
        ...
        <div className="page-break">
          ...
          <table style={{ height: "100%" }}>
            ...
            <tr>
              ...
              <td style={{ textAlign: "left" }}>Micronaire (µg/inch)</td>
              <td style={{ textAlign: "center" }}>-</td>
              <td style={{ textAlign: "center" }}>≥ 2.8 </td>
              <td style={{ textAlign: "center" }}>
                {printData.micronaire_actual}
              </td>
              <td style={{ textAlign: "center", padding: "0px" }}>
                {printData.micronaire_remarks}
              </td>
            </tr>
            <tr>
              <td style={{ textAlign: "center" }}> 18 </td>
              <td style={{ textAlign: "left" }}>UQL Fiber length (mm)</td>
              <td style={{ textAlign: "center" }}>-</td>
              <td style={{ textAlign: "center" }}>≥ 10</td>
              <td style={{ textAlign: "center" }}>{printData.uql_actual}</td>
              <td style={{ textAlign: "center", padding: "0px" }}>
                {printData.uql_remarks}
              </td>
            </tr>
            <tr>
              <td style={{ textAlign: "center" }}> 19 </td>
              <td style={{ textAlign: "left" }}>L(n) mm</td>
              <td style={{ textAlign: "center" }}>-</td>
              <td style={{ textAlign: "center" }}> ≥ 7.0</td>
              <td style={{ textAlign: "center" }}>{printData.l_actual}</td>
              <td style={{ textAlign: "center", padding: "0px" }}>
                {printData.l_remarks}
              </td>
            </tr>
...
export default QualityControl_f26_Summary;
