...
@Data
@Entity
@Table(name = "QC_BACTERIAL_INCUBATOR_TEMP_CALIBRATION_F012", schema = AppConstants.schema, uniqueConstraints = {
		@UniqueConstraint(columnNames = { "DATE","EQ_ID_NO"}) })
public class Qc_BacterialIncubatorTempCalibrationF012 extends UserDateAudit {
