...
@Data
@Entity
@Table(name = "SPUNLACE_SHIFT_WISE_SLITER_WINDER_PRODUCTION_DETAILS_F017",schema=AppConstants.schema)
public class ShiftWiseSliterWinderProdDetailsF017 extends UserDateAudit {
