...
@Data
public class BMRCottonWollRollResponcePrint {

	private List<BMR001GoodsProductionDetails> bmr001goodsproductiondetails;
	private List<BMR03GoodsPackingMeterialIssue> bmr03goodspackingmeterialissue;

	private List<BMR05GoodsEquipmentUsed> bmr05goodsequipmentused;

	private List<BMR06GoodsVerificationOfRecords> bmr06goodsverificationofrecords;

	private List<BMR07ManufacturingStepsCottonWoolRoll> bmr07manufacturingstepscottonwoolroll;

	private List<BMR09GoodsProcessDevRecord> bmr09goodsprocessdevrecord;

	private List<BMR10GoodsProcessDelayEqupment> bmr10goodsprocessdelayequpment;

	private List<BMR11GoodsListOfEnclouser> bmr11goodslistofenclouser;

	private List<BMR12GoodsPostProdReview> bmr12goodspostprodreview;

	private List<BMR13GoodsQaRelease> bmr13goodsqarelease;

	private List<BMR14GoodsProductRelease> bmr14goodsproductrelease;
	
	List<BudsBmrRework> reworkList;

	public BMRCottonWollRollResponcePrint(List<BMR001GoodsProductionDetails> bmr001goodsproductiondetails,
		...
		this.bmr07manufacturingstepscottonwoolroll = bmr07manufacturingstepscottonwoolroll;
