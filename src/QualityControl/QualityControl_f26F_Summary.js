...
const QualityControl_f26F_Summary = () => {
  ...
  const productLovApiPrint = async (value, type) => {
    try {
      const response = await axios.get(
        `${API.prodUrl}/Precot/api/QcForm/ProductF26?customer=${value}&formNo=F26F`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  useEffect(() => {
    if (!initialized.current) {
      ...
      const fetchData = async () => {
        try {
          const response = await axios.get(
            `${API.prodUrl}/Precot/api/QcForm/F26FInfusedCottonPadsSummary`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
  ...
  const handleOk = () => {
    ...
    navigate(`/Precot/QualityControl/F-026F`, {
      state: {
        customerName: formParams.customerName,
        productName: formParams.productName.value,
      },
    });
  };
  ...
  const handlePrint = async () => {
    ...
    try {
      const response = await axios.get(
        `${API.prodUrl}/Precot/api/QcForm/PrintApiF26F?product=${printParams.productName}&customer=${printParams.customerName}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  #section-to-print-san table td {
    ...
    `}
        ...
        <div className="page-break">
          <table style={{ borderCollapse: "collapse", width: "100%" }}>
            ...
            <tr>
              ...
              <td
                ...
                rowSpan={4}
              >
                CERTIFICATE OF ANALYSIS FOR INFUSED COTTON PADS{" "}
              </td>
              <td style={{ padding: "0.5em" }}>Format No.:</td>
              <td style={{ padding: "0.5em" }}>PH-QCL01/F-026F</td>
            </tr>
            <tr>
          ...
          <table style={{ height: "100%" }}>
            ...
            <tr>
              ...
              <td colSpan={3}>{printData.reference_no}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td style={{ textAlign: "center" }}>
                {printData.no_of_pads_standard}
              </td>
              <td style={{ textAlign: "center" }}>± 10 % </td>
              <td style={{ textAlign: "center" }}>
                {printData.no_of_pads_actual}
              </td>
              <td style={{ textAlign: "center", padding: "0px" }}>
                {printData.no_of_pads_remarks}
              </td>
            </tr>
            <tr>
              ...
              <td style={{ textAlign: "center" }}>60 ± 10 %</td>
              <td style={{ textAlign: "center" }}>
        ...
        <div className="page-break">
          ...
          <table style={{ height: "100%" }}>
            ...
            <tr>
              ...
              <td style={{ textAlign: "left" }}>Foreign fibres</td>
              <td style={{ textAlign: "center" }}>EP</td>
              <td style={{ textAlign: "center" }}>
              ...
              <td style={{ textAlign: "center" }}>
                {printData.foreign_fibres_actual}
              </td>
              <td style={{ textAlign: "center", padding: "0px" }}>
                {printData.foreign_fibres_remarks}
              </td>
            </tr>
            <tr>
              <td style={{ textAlign: "center" }}> 17 </td>
              <td style={{ textAlign: "left" }}>Neps</td>
              <td style={{ textAlign: "center" }}>EP</td>
              <td style={{ textAlign: "center" }}>Max. 5000</td>
              <td style={{ textAlign: "center" }}>{printData.neps_actual}</td>
              <td style={{ textAlign: "center", padding: "0px" }}>
                {printData.neps_remarks}
              </td>
            </tr>
            <tr>
              <td style={{ textAlign: "center" }}> 18 </td>
              <td style={{ textAlign: "left" }}>Average Fibre length</td>
              <td style={{ textAlign: "center" }}>EP</td>
              <td style={{ textAlign: "center" }}>{">"}10mm</td>
              <td style={{ textAlign: "center" }}>
                {printData.average_actual}
              </td>
              <td style={{ textAlign: "center", padding: "0px" }}>
                {printData.average_remarks}
              </td>
            </tr>
            <tr>
              ...
              <td style={{ textAlign: "center" }}>
                {" "}
                Alcohol extract may be
                <br /> slightly yellowish but
                <br /> not blue or green{" "}
              </td>
              <td style={{ textAlign: "center" }}>
                {printData.extractable_actual}
              </td>
              <td style={{ textAlign: "center", padding: "0px" }}>
                {printData.extractable_remarks}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td style={{ textAlign: "center" }} rowSpan={6}>
                {printData.pathogen_spec}
              </td>
              <td style={{ textAlign: "center" }}>{printData.bile_actual}</td>
              <td style={{ textAlign: "center" }}>{printData.bile_remarks}</td>
            </tr>
            <tr>
              <td style={{ textAlign: "left" }}>Escherichia coli (E.coli)</td>
              <td style={{ textAlign: "center" }}>
                {printData.escherichia_actual}
              </td>
              <td style={{ textAlign: "center" }}>
                {printData.escherichia_remarks}
              </td>
            </tr>
            <tr>
              <td style={{ textAlign: "left" }}>
              ...
              <td style={{ textAlign: "center" }}>
                {printData.staphylococcus_actual}
              </td>
              <td style={{ textAlign: "center" }}>
                {printData.staphylococcus_remarks}
              </td>
            </tr>
            <tr>
              <td style={{ textAlign: "left" }}>
              ...
              <td style={{ textAlign: "center" }}>
                {printData.pseudomonas_actual}
              </td>
              <td style={{ textAlign: "center" }}>
                {printData.pseudomonas_remarks}
              </td>
            </tr>
            <tr>
              <td style={{ textAlign: "left" }}>Salmonella</td>
              <td style={{ textAlign: "center" }}>
                {printData.salmonella_actual}
              </td>
              <td style={{ textAlign: "center" }}>
                {printData.salmonella_remarks}
              </td>
            </tr>
            <tr>
              <td style={{ textAlign: "left" }}>
              ...
              <td style={{ textAlign: "center" }}>
                {printData.burkholderia_actual}
              </td>

              <td style={{ textAlign: "center" }}>
                {printData.burkholderia_remarks}
              </td>
            </tr>
            <tr>
              <td colSpan={6}>
      ...
      />
      <Modal
        title="COA FOR INFUSED COTTON PADS (Print)"
        open={isModalPrint}
...
export default QualityControl_f26F_Summary;
