...
@Data
@Entity
@Table(name = "PADPUNCHING_MACHINE_CLEANING_CHECK_LIST_HISTORY_F005",schema=AppConstants.schema)
public class MachineCleaningCheckListHistoryF005 extends SaveSubmitSupervisorHod{
