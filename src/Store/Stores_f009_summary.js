      ...
      <div id="section-to-print">
        ...
        {Array.from({ length: totalPages }).map((_, pageIndex) => (
          <table     key={pageIndex} style={{ scale: "90%", marginLeft: "10px" }}>
            <thead>
              ...
              <tr style={{ height: "20px" }}>
                ...
                <td rowSpan="4" colSpan="5" style={{ textAlign: "center" }}>
                  <b>
                    Eye Wash With Shower <br /> Working Condition <br />
                    Checklist
                    <br /> (Chemical Store)
                  </b>{" "}
                </td>
                <td colSpan="1">Format No.:</td>
                <td colSpan="3">PH- STR01/F-009</td>
              </tr>
            ...
            <tbody>
              <tr>
                <th colSpan="1" style={{ textAlign: 'center' }}>Date</th>
                <th colSpan="1" style={{ textAlign: 'center' }}>
                  Shower Pull <br /> Rod <br /> Condition
                </th>
                <th colSpan="1" style={{ textAlign: 'center' }}>
                  Push <br /> Board <br />
                  Condition
                </th>
                <th colSpan="1" style={{ textAlign: 'center' }}>Water Flow</th>
                <th colSpan="2" style={{ textAlign: 'center' }}>
                  Performed <br /> By
                  <br /> (Sign & <br /> Date)
                </th>
                <th colSpan="2" style={{ textAlign: 'center' }}>
                  Verified By <br /> (Sign &<br /> Date)
                </th>
                <th colSpan="2" style={{ textAlign: 'center' }}>Remarks</th>
              </tr>
              {/* {printResponseData.map((data, index) => ( */}
              {paginateData(printResponseData, pageIndex + 1).map(
                  (data, index) => (
                <tr key={index}>
                  <th colSpan="1" style={{ textAlign: 'center', alignContent: 'center' }}>{formatDates(data.date)}</th>
                  <th colSpan="1" style={{ textAlign: 'center', alignContent: 'center' }}>{data.showerPullRod === "TICK" ? "✔" : data.showerPullRod === "CROSS" ? "X" : "NA"}</th>
                  <th colSpan="1" style={{ textAlign: 'center', alignContent: 'center' }}>{data.pushboard === "TICK" ? "✔" : data.pushboard === "CROSS" ? "X" : "NA"}</th>
                  <th colSpan="1" style={{ textAlign: 'center', alignContent: 'center' }}>{data.waterflow === "TICK" ? "✔" : data.waterflow === "CROSS" ? "X" : "NA"}</th>

                  <th colSpan="2" style={{ textAlign: 'center', alignContent: 'center' }}>
                    {getImage && (
                      <img
                        className="signature"
                        src={getImage}
                  ...
                  <th colSpan="2" style={{ textAlign: 'center', alignContent: 'center' }}>{data.remarks}</th>
                </tr>
              ))} 
            </tbody>
...
export default Stores_f009_summary;
