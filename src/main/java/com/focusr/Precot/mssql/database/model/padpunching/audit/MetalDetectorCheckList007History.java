...
@Data
@Entity
@Table(name = "PADPUNCHING_ARGUS_METAL_DETECTOR_CHECK_LIST_HISTORY_F007",schema=AppConstants.schema)
public class MetalDetectorCheckList007History extends SaveSubmitSupervisorHod{
