...
@Data
@Entity
@Table(name = "SPUNLACE_PROCESS_SETUP_VERIFICATION_RP_BALEPRESS_HISTORY_F013", schema = AppConstants.schema)
public class ProcessSetupVerificationRpBalePressHistoryF013 extends SpulanceSaveSubmitOperator{
