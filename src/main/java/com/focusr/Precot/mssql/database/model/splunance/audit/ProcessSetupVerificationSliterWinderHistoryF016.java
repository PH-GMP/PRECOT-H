...
@Data
@Entity
@Table(name = "SPUNLACE_PROCESS_SETUP_VERIFICATION_SLITER_WINDER_HISTORY_F016", schema = AppConstants.schema)
public class ProcessSetupVerificationSliterWinderHistoryF016 extends SpulanceSaveSubmitOperator{
