...
@Entity
@Table(name = "VALIDATION_FOR_AUTOCLAVE_CLF014", schema = AppConstants.schema)
@Data
public class validationAutoclave extends UserDateAudit{
    ...
    @Column(name = "CHEMICAL_INDICATOR")
