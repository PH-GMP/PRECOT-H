...
const Post_Production = (props) => {
  ...
  const sendPostProd = () => {
    ...
    if (role == "ROLE_SUPERVISOR") {
      if (postprod.supervisor_sign == "" || postprod.supervisor_date == "") {
    ...
    if (role == "ROLE_QA") {
      if (postprod.qa_sign == "" || postprod.qa_date == "") {
        message.warning("All Fields Are Required");
        return;
      }
    }
    ...
    const payload = {
      ...
      sup_sign: postprod.supervisor_sign,
      sup_date: postprod.supervisor_date,
      sup_time: "",
      designee_sign: postprod.hod_sign,
      designee_date: postprod.hod_date,
      designee_time: "",
      qa_sign: postprod.qa_sign,
