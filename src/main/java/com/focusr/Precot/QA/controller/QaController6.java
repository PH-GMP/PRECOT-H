...
public class QaController6 {
	...
	public ResponseEntity<?> SaveMetalDetector(HttpServletRequest http,
			@Valid @RequestBody MetalDetectorCalibrationRecord templateForRecall, BindingResult result,
			Principal principal) {
	...
	public ResponseEntity<?> MetalDetectorSummary(@RequestParam Map<String, String> requestParams,
...
//		}
	...
	public ResponseEntity<?> MetalPassSummary(@RequestParam Map<String, String> requestParams, HttpServletRequest http,
			Principal principal) {
	...
	public ResponseEntity<?> MetalDetectorPassPrint(@RequestParam Map<String, String> requestParams,
			Principal principal) {
	...
	public ResponseEntity<?> TrainingRecordSummary(@RequestParam Map<String, String> requestParams,
			HttpServletRequest http, Principal principal) {
	...
	@GetMapping("getDataByBatchNo")
	public ResponseEntity<?> getDataByBatchNo(@RequestParam Map<String, String> requestParams, Principal principal) {

		String batchNo = requestParams.get("batchNo");

		ResponseEntity<?> resp = qaService6.getDataByBatchNo(batchNo);
		return resp;
	}

	@GetMapping("getItemCode")
	public ResponseEntity<?> getItemCode(@RequestParam Map<String, String> requestParams, Principal principal) {

		String porder = requestParams.get("porder");

		ResponseEntity<?> resp = qaService6.getItemCode(porder);
		return resp;
	}

	@GetMapping("getCustomerName")
	public ResponseEntity<?> getCustomerName(@RequestParam Map<String, String> requestParams, Principal principal) {

		String material = requestParams.get("material");

		ResponseEntity<?> resp = qaService6.getCustomerName(material);
		return resp;
	}
