...
@Entity
@Table(name = "BLEACH_SMS_ACTIVITIES_F01", schema = AppConstants.schema)
public class BleachSMSActivitiesF01 {
	...
	public BleachSMSActivitiesF01(Long id, String description, boolean completed, boolean notApplicable) {
		super();
		this.id = id;
		this.description = description;
		this.completed = completed;
