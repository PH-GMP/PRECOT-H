...
const Post_Production = (props) => {
  ...
  useEffect(() => {
    axios
      .get(
        `${API.prodUrl}/Precot/api/buds/bmr/getPostProductionReview?batchNo=${props.batchNo}`,
        {
          headers: {
      ...
      .then((res) => {
        ...
        if (res.data.length > 0) {
          ...
          updatePostProd({
            ...
            supervisor_date: res.data[0].supervisorDate,
            hod_date: res.data[0].hodDate,
            qa_date: res.data[0].qaDate,
            id: res.data[0].id,
  ...
  const sendPostProd = () => {
    const payload_2 = {
      ...
      qaId: postprod.qa_id,
      qaDate: postprod.qa_date,
      hodStatus: postprod.hodStatus,
      hodName: postprod.hod_sign,
      hodId: postprod.hod_id,
      hodDate: postprod.hod_date,
      supervisorStatus: postprod.supervisorStatus,
      supervisorName: postprod.supervisor_sign,
      supervisorId: postprod.sup_id,
      supervisorDate: postprod.supervisor_date,
      formatName: "Post-Production Review Format",
      formatNumber: "PPR-001",
      id: postprod.id,
    };
    axios
      .post(
        `${API.prodUrl}/Precot/api/buds/bmr/submitPostProductionReview`,
        payload_2,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
          ...
          <Button
            ...
            style={{
              ...
              display:
                ...
                (props.loggedInQaManandQADesignee &&
                  postprod.qaStatus == "QA_APPROVED") ||
