...
@JsonIgnoreProperties(value = { "operator_status", "operator_save_by", "operator_save_on", "operator_save_id",
		...
		"operator_signature_image", "supervisor_status", "supervisor_submit_on", "supervisor_submit_by",
		"supervisor_submit_id", "supervisor_sign",
		"supervisor_signature_image" }, allowGetters = true, allowSetters = true)
public class SaveSubmitOperatorSupervisorHod extends UserDateAudit{
