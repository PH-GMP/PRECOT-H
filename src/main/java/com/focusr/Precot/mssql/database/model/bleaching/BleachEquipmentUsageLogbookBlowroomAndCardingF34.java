...
@Entity
@Table(name = "BLEACH_EQUIPMENT_USAGE_LOGBOOK_BLOWROOM_AND_CARDING_F34",schema=AppConstants.schema)
	
public class BleachEquipmentUsageLogbookBlowroomAndCardingF34 extends UserDateAudit  {
	...
	@Column(name = "BMR_NUMBER", unique = true)
   ...
   @Column(name = "SUPERVISOR_STATUS")
	...
	public Long getEquipb_id() {
		return equipb_id;
	}

	public void setEquipb_id(Long equipb_id) {
		this.equipb_id = equipb_id;
	}
