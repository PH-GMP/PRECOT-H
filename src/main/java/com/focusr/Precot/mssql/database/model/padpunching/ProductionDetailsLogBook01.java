...
@Data
@Entity
@Table(name = "PRODUCTION_DETAILS_LOG_BOOK_F01", schema = AppConstants.schema, uniqueConstraints = {
		@UniqueConstraint(columnNames = { "DATE", "SHIFT" }) })

public class ProductionDetailsLogBook01 extends SaveSubmitSupervisorHod {
