...
import com.focusr.Precot.util.drygoods.BMRCottonPleatResponsePrint;

@Service
public class BmrCottonPleatService {

	Logger log = LoggerFactory.getLogger(BmrCottonPleatService.class);
	...
	@SuppressWarnings("unchecked")
	public ResponseEntity<?> SubmitProductionDetails(BMR001GoodsProductionDetails details, HttpServletRequest http) {
		SCAUtil sca = new SCAUtil();
	...
	public ResponseEntity<?> GetProductionDetails(String batch_no) {
		...
		try {
			bmrSummaryDateList = bmr001goodsproductiondetailsrepository.getDetailscp(batch_no);
	...
	public ResponseEntity<?> GetPackingMeterial(String batch_no) {
		...
		try {
			bmrSummaryDateList = bmr03goodspackingmeterialissuerepository.getDetails07(batch_no);
	...
	public ResponseEntity<?> GetProcessEqupDetails(String batch_no) {
		...
		try {
			bmrSummaryDateList = bmr05equipmentusedrepository.getDetailscp(batch_no);
	...
	public ResponseEntity<?> SubmitVerificationOfRecords(BMR06GoodsVerificationOfRecords details,
		...
		try {
			...
			if (id != null) {
				...
				checkObj = bmr06goodsverificationofrecordsrepository.getSummaryByVerification_id07(id);
...
//					checkObj = details;
	...
	public ResponseEntity<?> GetVerificationOfRecords(String batch_no) {
		...
		try {
			bmrSummaryDateList = bmr06goodsverificationofrecordsrepository.getDetailscp(batch_no);
	...
	public ResponseEntity<?> SubmitManufacturingSteps(BMR07ManufacturingStepsCottonWoolRoll details,
		...
		try {
			...
			if (id != null) {
				...
				checkObj = bmr07goodsmanufacturingstepscottonwoolroolrepository.getmanufacturingStepsById07cp(id);
...
//						checkObj = details;
	...
	public ResponseEntity<?> GetManufacturingSteps(String batch_no) {
		...
		try {
			bmrSummaryManufacturingStepsWool = bMR07GoodsManufacturingStepsCottonWoolRoolRepository
					.getManufacturingStepspleat(batch_no);
	...
	public ResponseEntity<?> GetProcessDevRecord(String batch_no) {
		...
		try {
			bmrSummaryDateList = bmr09goodsprocessdevrecordrepository.getDetailscp(batch_no);
	...
	public ResponseEntity<?> GetProcessDelayEqupment(String batch_no) {
		...
		try {
			bmrSummaryDateList = bmr10goodsprocessdelayequpmentrepository.getDetailscp(batch_no);
	...
	public ResponseEntity<?> GetListOfEnclosurs(String batch_no) {
		...
		try {
			bmrSummaryDateList = bmr11goodslistofenclouserrepository.getDetailscp(batch_no);
	...
	public ResponseEntity<?> GetPostProductionReview(String batch_no) {
		...
		try {
			bmrSummaryDateList = bmr12goodspostprodreviewrepository.getDetailscp(batch_no);
	...
	public ResponseEntity<?> GetQaRelease(String batch_no) {
		...
		try {
			bmrSummaryDateList = bmr13goodsqareleaserrepository.getDetailscp(batch_no);
...
//				details.setSupervisor_id(userId);
	...
	public ResponseEntity<?> GetProductRelease(String batch_no) {
		...
		try {
			bmrSummaryDateList = bmr14goodsproductreleaserepository.getDetailscp(batch_no);
...
//			productionDetailsList = bmr001goodsproductiondetailsrepository.productionDetailsBatchNumberpleat();
//
...
//	}
	...
	public ResponseEntity<?> getProductionLOV() {
		...
		try {
			// FROM SAP
			productionBatchDb = bmr001goodsproductiondetailsrepository.productionDetailsBatchNumberpleat();

			// INCREMENTAL FOR OPEN BATCHES
			productionnextBatch = bmr001goodsproductiondetailsrepository.fetchOpenBatchesform7();
...
//
//	public ResponseEntity<?> getProductionResponseByBatchOrder(String batchNo, String orderNo) {
//		
...
//		try {
//			
//			productionDetailsResponse = bmr001goodsproductiondetailsrepository.productionResponseByBatchOrder(batchNo, orderNo);
//			
...
//	}
	...
	public ResponseEntity<?> getProductionResponseByBatchOrder(String batchNo, String orderNo, String fromDate,
		...
		try {
			...
			goodsDetailsResponse = bmr001goodsproductiondetailsrepository.productionResponseByBatchOrderPleat(batchNumber,
					orderNo);
...
//				}
				...
				if (genNumber.equals("1")) {
					...
					farQuantityBag = bmr001goodsproductiondetailsrepository.soFarPackQtyBagPleat(batchNumber);
					farQuantityBox = bmr001goodsproductiondetailsrepository.soFarPackQtyBoxPleat(batchNumber);
				}
	...
	public ResponseEntity<?> GetCottonPleatPrint(String batch_no) {
		...
		try {
			bmr001goodsproductiondetails = bmr001goodsproductiondetailsrepository.getDetailscp(batch_no);
			bmr03goodspackingmeterialissue=bmr03goodspackingmeterialissuerepository.getDetails07(batch_no);
			bmr05goodsequipmentused = bmr05equipmentusedrepository.getDetailscp(batch_no);
			bmr06goodsverificationofrecords = bmr06goodsverificationofrecordsrepository.getDetailscp(batch_no);
			bmr07goodsmanufacturingstepscottonballs = bmr07goodsmanufacturingstepscottonballrepository
					.getDetailscp(batch_no);
			bmr09goodsprocessdevrecord = bmr09goodsprocessdevrecordrepository.getDetailscp(batch_no);
			bmr10goodsprocessdelayequpment = bmr10goodsprocessdelayequpmentrepository.getDetailscp(batch_no);
			bmr11goodslistofenclouser = bmr11goodslistofenclouserrepository.getDetailscp(batch_no);
...
//			}
			...
			productReconillation.setForm_no("Pleat");
	...
	public ResponseEntity<?> getProductReconillationForPleatsByBatchNumber(String batchNo) {
		
		List<BMR10GoodsProductReconillation> reconillationList = new ArrayList<BMR10GoodsProductReconillation>();
		
		try {
			
			reconillationList = reconillationRepository.fetchReconillationPleats(batchNo);
