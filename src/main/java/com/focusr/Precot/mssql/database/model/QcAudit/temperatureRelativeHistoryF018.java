...
@Entity
@Table(name = "TEMPERATURE_RELATIVE_HUMIDITY_RECORD_F018_HISTORY", schema = AppConstants.schema)
@Data
public class temperatureRelativeHistoryF018 extends UserDateAudit {
