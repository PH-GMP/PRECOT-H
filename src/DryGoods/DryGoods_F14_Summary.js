...
const HouseKeepingSummary_14 = () => {
  // const [formatNo, setFormatNo]=useState("PRD03/F-26");
  const [formatNo, setFormatNo] = useState("PH-HRD01/F-004");
  const [formName, setFormName] = useState("House Keeping Cleaning Check List");
  const [department, setDepartment] = useState("DryGoods");
...
`;
  ...
  useEffect(() => {
    const fetchData = () => {
      ...
      axios
        .get(
          `${API.prodUrl}/Precot/api/Drygoods/Service/getHouseKeepingSummaryF14`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
  ...
  const fetchPrintData = (newData, month, year) => {
    ...
    return records.map((record) => {
      ...
      return {
        day,
        floor_cleaning_dry: transformValue(record.floor_cleaning_dry),
        ...
        floor_cleaning_wet: transformValue(record.floor_cleaning_wet),
        ...
        false_ceiling: transformValue(record.false_ceiling),
        // rapidDoors: transformValue(record.rapid_doors),
        remark: record.remarks,
        trained_person: record.trained_person,
      };
    });
  };
  ...
  const handleprintMonthChange = (selectMonth) => {
    ...
    axios
      .get(
        `${API.prodUrl}/Precot/api/Drygoods/Service/getHouseKeepingMonthYearSummaryF14`,
        {
          headers,
          params: {
            month: selectMonth,
        ...
        <table className="f18table" style={{ marginTop: "2%", width: "80%" }}>
          <tbody>
              ...
              {dateLov.map((date, rowIndex) => {
                ...
                return (
                  <td key={rowIndex} className="data-border" colSpan="2">
                    ...
                    >
                      {printData ? printData.floor_cleaning_dry : "NA"}
                    </p>
                  </td>
                );
              })}
              ...
              {dateLov.map((date, rowIndex) => {
                ...
                return (
                  <td key={rowIndex} className="data-border" colSpan="2">
                    ...
                    >
                      {printData ? printData.removel_unwanted_meterials : "NA"}
                    </p>
                  </td>
                );
              })}
              ...
              {dateLov.map((date, rowIndex) => {
                ...
                return (
                  <td key={rowIndex} className="data-border" colSpan="2">
                    ...
                    >
                      {printData ? printData.side_wall_corners : "NA"}
                    </p>
                  </td>
                );
              })}
            ...
            <tr>
              ...
              <td colSpan="17"> Drinking Water Tank</td>
              <td
                colSpan="8"
                rowSpan="6"
              ...
              {dateLov.map((date, rowIndex) => {
                ...
                return (
                  <td key={rowIndex} className="data-border" colSpan="2">
                    ...
                    >
                      {printData ? printData.drink_water_tank : "NA"}
                    </p>
                  </td>
                );
              })}
              ...
              {dateLov.map((date, rowIndex) => {
                ...
                return (
                  <td key={rowIndex} className="data-border" colSpan="2">
                    ...
                    >
                      {printData ? printData.floor_cleaning_wet : "NA"}
                    </p>
                  </td>
                );
              })}
              ...
              {dateLov.map((date, rowIndex) => {
                ...
                return (
                  <td key={rowIndex} className="data-border" colSpan="2">
                    ...
                    >
                      {printData ? printData.emergency_door : "NA"}
                    </p>
                  </td>
                );
              })}
              ...
              {dateLov.map((date, rowIndex) => {
                ...
                return (
                  <td key={rowIndex} className="data-border" colSpan="2">
                    ...
                    >
                      {printData ? printData.fire_extinguishers : "NA"}
                    </p>
                  </td>
                );
              })}
              ...
              {dateLov.map((date, rowIndex) => {
                ...
                return (
                  <td key={rowIndex} className="data-border" colSpan="2">
                    ...
                    >
                      {printData ? printData.first_aid_box : "NA"}
                    </p>
                  </td>
                );
              })}
              ...
              {dateLov.map((date, rowIndex) => {
                ...
                return (
                  <td key={rowIndex} className="data-border" colSpan="2">
                    ...
                    >
                      {printData ? printData.rapid_doors : "NA"}
                    </p>
                  </td>
                );
              })}
              ...
              {dateLov.map((date, rowIndex) => {
                ...
                return (
                  <td key={rowIndex} className="data-border" colSpan="2">
                    ...
                    >
                      {printData ? printData.false_ceiling : "NA"}
                    </p>
                  </td>
                );
              })}
              ...
              {dateLov.map((date, rowIndex) => {
                ...
                return (
                  <td key={rowIndex} className="data-border" colSpan="2">
                    ...
                    >
                      {printData ? printData.trained_person : "NA"}
                    </p>
                  </td>
                );
              })}
...
export default HouseKeepingSummary_14;
