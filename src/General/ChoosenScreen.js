  ...
  const PadPunchingForm = [
    {
      ...
      options: [
        ...(role !== "ROLE_OPERATOR"
          ? [
            {
              value: "PH-QAD01-F-054",
              label: "PH-QAD01-F-054 PRODUCTION DETAILS - LOG BOOK",
            },
          ]
          : []),
        {
        ...
        ...(role !== "ROLE_OPERATOR"
          ? [
            ...
            },
            {
              ...
              label: "PH-PRD03-F-006 ARGUS METAL DETECTOR- CHECK LIST",
            },
            {
            ...
            {
              value: "PH-QAD01/F-070",
              label: "PH-QAD01/F-070 BATCH MANUFACTURING RECORD",
            },
          ]
          : []),
