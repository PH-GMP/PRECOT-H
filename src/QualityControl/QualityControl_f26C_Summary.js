...
const QualityControl_f26C_Summary = () => {
  ...
  const productLovApiPrint = async (value, type) => {
    try {
      const response = await axios.get(
        `${API.prodUrl}/Precot/api/QcForm/ProductF26?customer=${value}&formNo=F26C`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  useEffect(() => {
    if (!initialized.current) {
      ...
      const fetchData = async () => {
        try {
          const response = await axios.get(
            `${API.prodUrl}/Precot/api/QcForm/F26CCottonWoolRollSummary`,
            {
              headers: {
                Authorization: `Bearer ${token}`,
              },
  ...
  const handleOk = () => {
    ...
    navigate(`/Precot/QualityControl/F-026C`, {
      state: {
  ...
  const handlePrint = async () => {
    ...
    try {
      const response = await axios.get(
        `${API.prodUrl}/Precot/api/QcForm/PrintApiF26C?product=${printParams.productName}&customer=${printParams.customerName}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  #section-to-print-san table td {
    ...
    `}
        ...
        <div className="page-break">
          <table style={{ borderCollapse: "collapse", width: "100%" }}>
            ...
            <tr>
              ...
              <td
                ...
                rowSpan={4}
              >
                CERTIFICATE OF ANALYSIS FOR COTTON WOOL ROLL
              </td>
              <td style={{ padding: "0.5em" }}>Format No.:</td>
              <td style={{ padding: "0.5em" }}>PH-QCL01/F-026C</td>
            </tr>
            <tr>
          ...
          <table style={{ height: "100%" }}>
            ...
            <tr>
              ...
              <td style={{ textAlign: "center" }}>Surface active Substances</td>
              <td style={{ textAlign: "center" }}>EP</td>
              <td style={{ textAlign: "center" }}>
            ...
            <tr>
              ...
              <td style={{ textAlign: "center" }}>Absorption Capacity (g/g)</td>
              <td style={{ textAlign: "center" }}>EP</td>
      ...
      />
      <Modal
        title="COA FOR COTTON WOOL ROLL (Print)"
        open={isModalPrint}
...
export default QualityControl_f26C_Summary;
