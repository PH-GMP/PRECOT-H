        ...
        <table style={{ tableLayout: "fixed" }}>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colSpan={6}>Observation</td>
            </tr>

            <tr>
              <td colSpan={2}>1</td>
              <td colSpan={6}>Box Dimension - L x W x H (mm)</td>
              <td colSpan={6}>
            ...
            <tr>
              ...
              <td colSpan={5}>Defects</td>
              <td colSpan={4}>No. Of Defects Observed</td>
              <td colSpan={4}>Total No. ofDefects Observed</td>
              <td colSpan={4}>Maximum No. of Defects Allowed</td>
            </tr>
            ...
            <tr>
              ...
              <td colSpan={5}>Wrong/Incorrect Dimension </td>
              <td colSpan={4}>
                {printResponseData?.[0]?.line2[2].no_of_defects}
              </td>
              <td colSpan={4} rowSpan={6}>
                {printResponseData?.[0]?.line2[2].total_no_of_defects}
              </td>
              <td colSpan={4} rowSpan={6}>
                {printResponseData?.[0]?.line2[2].maximum_no_of_defects}
              </td>
            </tr>
            <tr>
              <td colSpan={1}>2</td>
              <td colSpan={5}>Improper Printing / Text Font</td>
              <td colSpan={4}>
            ...
            <tr>
              <td colSpan={1}>3</td>
              <td colSpan={5}>Major colour shade Deviation Number</td>
              <td colSpan={4}>
            ...
            <tr>
              <td colSpan={1}>5</td>
              <td colSpan={5}>Bad Odour / Smell</td>
              <td colSpan={4}>
            ...
            <tr>
              <td colSpan={1}>6</td>
              <td colSpan={5}>Improper Perforation</td>
              <td colSpan={4}>
            ...
            <tr>
              ...
              <td colSpan={4} rowSpan={7}>
                {printResponseData?.[0]?.line2[8].total_no_of_defects}
              </td>
              <td colSpan={4} rowSpan={7}>
                {printResponseData?.[0]?.line2[8].maximum_no_of_defects}
              </td>
            </tr>

            <tr>
              <td colSpan={1}>2</td>
              <td colSpan={5}>Paper Cutting Not Proper</td>
              <td colSpan={4}>
            ...
            <tr>
              <td colSpan={1}>3</td>
              <td colSpan={5}>Different Printing font(Eligible )</td>
              <td colSpan={4}>
            ...
            <tr>
              <td colSpan={1}>4</td>
              <td colSpan={5}>Open/Improper joints of cartons</td>
              <td colSpan={4}>
            ...
            <tr>
              <td colSpan={1}>5</td>
              <td colSpan={5}>Fold mark / Wrinkles</td>
              <td colSpan={4}>
            ...
            <tr>
              <td colSpan={1}>6</td>
              <td colSpan={5}>Shifting of Artwork</td>
              <td colSpan={4}>
            ...
            <tr>
              <td colSpan={8} rowspan={2}>
                COA Reference No.:{printResponseData?.[0]?.coa_reference_no}
              </td>
...
export default QA_Inward029_Sum;
