...
const Verification_Of_Records = (props) => {
 ...
 const getCurrentDateTime = () => {
      ...
      axios
        ...
        .then((response) => {
          ...
          if (response.data[0].detailsVerificationRecords.length > 0) {
            ...
            const observation9 =
              response.data[0].detailsVerificationRecords.filter((x) => {
                return x.name_of_record == "Observation9";
              });
            updateVerification({
              ...
              wasteRecordStatus: observation9[0].activity,
              ...
              VerifiedBySign9: observation9[0].verified_sign,
              ...
              CheckedBySign9: observation9[0].checked_sign,
              ...
              VerifiedByDate9: observation9[0].verified_date,
              ...
              CheckedByDate9: observation9[0].checked_date,
            });
            updateIDs({
  ...
  const arrayOfOnChange = {
    ...
    onChangeCheckedBy9: (value) => {
      console.log("value", value);
      updateVerification({
        CheckedBySign9: value,
      });
    },
    ...
    onChangeVerifiedBy17: (value) => {
      console.log("value", value);
      updateVerification({
        VerifiedBySign9: value,
      });
    },
  };
  ...
  const saveVerificationRecords = async () => {
    ...
    const payload = {
      ...
      detailsVerificationRecords: [
        ...
        {
          // verification_id: "",
          checked_date: verificationRecords.CheckedByDate9,
          checked_time: "",
          checked_name: "",
          checked_sign: verificationRecords.CheckedBySign9,
          verified_date: verificationRecords.VerifiedByDate9,
          verified_time: "",
          verified_name: "",
          verified_sign: verificationRecords.VerifiedBySign9,
          activity: verificationRecords.wasteRecordStatus,
          name_of_record: "Observation9",
        },
      ],
    };
    const payload_2 = {
  ...
  const submitVerificationRecords = async () => {
    ...
    if (props.loggedInQa) {
      ...
      const payload_2 = {
        ...
        detailsVerificationRecords: [
          ...
          },
          {
            ...
            verified_name: "",
            verified_sign: verificationRecords.VerifiedBySign9,
            activity: verificationRecords.wasteRecordStatus || "NA",
            name_of_record: "Observation9",
          },
        ],
      };
      if (
        ...
        verificationRecords.VerifiedBySign9 == "" ||
        ...
        verificationRecords.VerifiedByDate9 == ""
      ) {
      ...
      axios
        ...
        .catch((err) => {
          setButtonLoader(false);
          console.log("Error Occured", err.res?.data?.message);
      ...
      if (
        ...
        verificationRecords.CheckedBySign9 == "" ||
        ...
        verificationRecords.CheckedByDate9 == ""
      ) {
        message.warning("Please Select All Required Fields");
        return;
      }
          ...
          <tr>
            ...
            <td colSpan="3">
              <Select
                ...
                value={verificationRecords.CheckedBySign9 || usernameSupervisor}
                onChange={arrayOfOnChange.onChangeCheckedBy9}
                disabled={!props.loggedInSupervisor || supervisorApproved}
              />
              <Input
                type="datetime-local"
                onChange={(e) =>
                  updateVerification({
                    CheckedByDate9: e.target.value,
                  })
                }
                value={verificationRecords.CheckedByDate9}
                disabled={!props.loggedInSupervisor || supervisorApproved}
                max={todayDateTime}
              />
            </td>
            <td colSpan="3">
              <Select
                ...
                value={verificationRecords.VerifiedBySign9 || username}
                onChange={arrayOfOnChange.onChangeVerifiedBy17}
                disabled={
                  !props.loggedInQa ||
                  qaApproved ||
                  (!supervisorApproved && props.loggedInQa)
              ...
              <Input
                ...
                onChange={(e) =>
                  updateVerification({
                    VerifiedByDate9: e.target.value,
                  })
                }
                value={verificationRecords.VerifiedByDate9}
                disabled={
                  !props.loggedInQa ||
                  qaApproved ||
                  (!supervisorApproved && props.loggedInQa)
            ...
            <td colSpan="3">
              <Radio.Group
                ...
                onChange={(e) =>
                  updateVerification({
                    wasteRecordStatus: e.target.value,
                  })
                }
                value={verificationRecords.wasteRecordStatus}
                disabled={
                  !props.loggedInQa ||
                  qaApproved ||
                  (!supervisorApproved && props.loggedInQa)
