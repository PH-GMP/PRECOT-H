...
@Entity
@Table(name = "BUDS_DAILY_PRODUCTION_STOPPAGE_LINE", schema = AppConstants.schema)
public class BudsDailyProductionStoppageLine  extends UserDateAudit {
...
//	@JsonIgnore
//    private BudsDailyProductionSliverHeader stoppage;
