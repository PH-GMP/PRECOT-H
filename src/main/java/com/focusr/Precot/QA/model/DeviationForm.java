...
@Data
@Entity
@Table(name = "QA_DEVIATION_FORM", schema = AppConstants.schema ,
uniqueConstraints=@UniqueConstraint(columnNames= {"DATE_OF_INITIATION","MONTH","DEVIATION_NUMBER"}))
public class DeviationForm extends UserDateAudit{
	@Id
	...
	private Long sec2SupervisorSubmitId;

	@Column(name = "SEC2_SUPERVISOR_SIGN")
	private String sec2SupervisorSign;
	...
	private Long sec3SupervisorSubmitId;

	@Column(name = "SEC3_SUPERVISOR_SIGN")
	private String sec3SupervisorSign;
	...
	@Column(name = "SEC3_QA_MANAGER_MR_SUBMIT_ON")
