  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        let apiUrl = `${
          API.prodUrl
        }/Precot/api/qa/getSummarydetailsInward?formatNo=${"PH-QAD01-F-030"}`;
  ...
  const fetchPrintGet = async (date) => {
    ...
    try {
      ...
      const response = await axios.get(
        `${
          API.prodUrl
        }/Precot/api/qa/getdetailsForPrintInward?formatNo=${"PH-QAD01-F-030"}&gr_date=${date}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
  ...
  const handlePrintSupplier = async (SelectedPrintSupplier) => {
    try {
      ...
      const response = await axios.get(
        `${
          API.prodUrl
        }/Precot/api/qa/getdetailsForPrintInward?formatNo=${"PH-QAD01-F-030"}&gr_date=${printDate}&supplierName=${SelectedPrintSupplier}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
  ...
  const handlePrintInvoiceSelection = async (SelectedInvoicePrint) => {
    try {
      ...
      const response = await axios.get(
        `${
          API.prodUrl
        }/Precot/api/qa/getdetailsForPrintInward?formatNo=${"PH-QAD01-F-030"}&gr_date=${printDate}&supplierName=${SelectedPrintSupplier}&invoice_no=${SelectedInvoicePrint}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
  ...
  const handlePrintiirselection = async (SelectediirNumbers) => {
    try {
      ...
      const response = await axios.get(
        `${
          API.prodUrl
        }/Precot/api/qa/getdetailsForPrintInward?formatNo=${"PH-QAD01-F-030"}&gr_date=${printDate}&supplierName=${SelectedPrintSupplier}&invoice_no=${SelectedInvoicePrint}&iir_no=${SelectediirNumbers}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
        ...
        <table style={{ tableLayout: "fixed" }}>
          <thead style={{ marginTop: "15px" }}>
            <tr>
              ...
              <th colSpan={9} rowspan={4} style={{ textAlign: "center" }}>
                INWARD INSPECTION REPORT (for Film)
              </th>
              <th colSpan={3}>Format No.:</th>
              <th colSpan={3}>PH-QAD01-F-030</th>
            </tr>
            <tr>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colSpan={6}>PDS No.:{printResponseData?.[0]?.pds_no}</td>
              <td colSpan={4}>GR Date:{formattedgrDate} </td>
              <td colSpan={4}>GR No: {printResponseData?.[0]?.gr_no} </td>
            </tr>
            <td colSpan={6}>
              No of Rolls.: {printResponseData?.[0]?.no_of_rolls}{" "}
            </td>
            <td colSpan={4}>
              No of Sample Rolls.:{printResponseData?.[0]?.no_of_sample_rolls}
            </td>
            <td colSpan={4}>
              Sample Qty.: {printResponseData?.[0]?.sample_quantity}
            </td>
            <td colSpan={6} rowSpan={2}>
              Sample Plan : For ≤3 rolls: Inspection each roll 1 meter ≥4 rolls:
              √n+1 (n is No. of rolls)
            </td>
            ...
            <tr>
              ...
              <td colSpan={6}>Width of Film (mm)</td>
              <td colSpan={6}>
            ...
            <tr>
              ...
              <td colSpan={6}>Thickness of Film (micron)</td>
              <td colSpan={6}>
            ...
            <tr>
              ...
              <td colSpan={6}>Bar code Number</td>
              <td colSpan={6}>
            ...
            <tr>
              ...
              <td colSpan={6}>Artwork & Printed Text Matter</td>
              <td colSpan={6}>
            ...
            <tr>
              ...
              <td colSpan={5} rowSpan={3} style={{ textAlign: "center" }}>
                {" "}
                Critical
              </td>
              <td colSpan={6}>Old / Obsolete/Incorrect Artwork</td>
              <td colSpan={6}>
                {printResponseData?.[0]?.line2[0].defect_observation}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td colSpan={6}>Bar code Wrong / Not Scanning</td>
              <td colSpan={6}>
                {printResponseData?.[0]?.line2[1].defect_observation}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td colSpan={6}>Different basic film used</td>
              <td colSpan={6}>
                {printResponseData?.[0]?.line2[2].defect_observation}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td colSpan={5} rowSpan={6} style={{ textAlign: "center" }}>
                Major
              </td>
              <td colSpan={6}>Illegible Printing </td>
              <td colSpan={6}>
                {printResponseData?.[0]?.line2[3].defect_observation}
              </td>
            </tr>
            <tr>
              <td colSpan={3} style={{ textAlign: "center" }}>
              ...
              <td colSpan={6}>Shifted Artwork</td>
              <td colSpan={6}>
                {printResponseData?.[0]?.line2[4].defect_observation}
              </td>
            </tr>
            <tr>
              <td colSpan={3} style={{ textAlign: "center" }}>
              ...
              <td colSpan={6}>Major colour shade deviation</td>
              <td colSpan={6}>
                {printResponseData?.[0]?.line2[5].defect_observation}
              </td>
            </tr>
            <tr>
              <td colSpan={3} style={{ textAlign: "center" }}>
              ...
              <td colSpan={6}>Wrong film roll Width</td>
              <td colSpan={6}>
                {printResponseData?.[0]?.line2[6].defect_observation}
              </td>
            </tr>
            <tr>
              <td colSpan={3} style={{ textAlign: "center" }}>
              ...
              <td colSpan={6}>Roll Winding Proper/ Not Proper</td>
              <td colSpan={6}>
                {printResponseData?.[0]?.line2[7].defect_observation}
              </td>
            </tr>
            <tr>
              <td colSpan={3} style={{ textAlign: "center" }}>
              ...
              <td colSpan={6}>Inner core Tube Dimension</td>
              <td colSpan={6}>
                {printResponseData?.[0]?.line2[8].defect_observation}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td colSpan={5} rowSpan={5} style={{ textAlign: "center" }}>
                Minor
              </td>
              <td colSpan={6}>Unwanted Colour Spot</td>
              <td colSpan={6}>
                {printResponseData?.[0]?.line2[9].defect_observation}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td colSpan={6}>Sticky Film</td>
              <td colSpan={6}>
                {printResponseData?.[0]?.line2[10].defect_observation}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td colSpan={6}>Less/ More Thickness of Film</td>
              <td colSpan={6}>
                {printResponseData?.[0]?.line2[11].defect_observation}
              </td>
            </tr>
            <tr>
              <td colSpan={3} style={{ textAlign: "center" }}>
              ...
              <td colSpan={6}>Minor colour shade deviation</td>
              <td colSpan={6}>
                {printResponseData?.[0]?.line2[12].defect_observation}
              </td>
            </tr>
            <tr>
              <td colSpan={3} style={{ textAlign: "center" }}>
              ...
              <td colSpan={6}>Folding/ Wrinkles</td>
              <td colSpan={6}>
                {printResponseData?.[0]?.line2[13].defect_observation}
              </td>
            </tr>
            ...
            <tr>
              <td colSpan={7}>
                Rolls Accepted:
                <br />
                {printResponseData?.[0]?.accepted}
              </td>

              <td colSpan={7}>
                Rolls Rejected:
                <br />
                {printResponseData?.[0]?.rejected}
              </td>
      ...
      >
        ...
        >
          ...
          <Select
            ...
            placeholder="Select Supplier"
            value={SelectedPrintSupplier || undefined}
            onChange={(value) => {
...
export default QA_Inward030_Sum;
