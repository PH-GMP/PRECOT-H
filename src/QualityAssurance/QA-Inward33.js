...
const QA_Inward033 = () => {
  ...
  const [observation8, setobsevation8] = useState("");
  ...
  const [coa_reference_no, setcoa_reference_no] = useState("");
  ...
  useEffect(() => {
    ...
    const sum8 = Number(Number6) + Number(Number7);
    setTotal8(sum8);

    const sum9 = Number(Number8) + Number(Number9) + Number(Number10);
    setTotal9(sum9);
  });
  ...
  const handleApprove = async () => {
    ...
    const res = await axios
      ...
      .then((res) => {
        ...
        navigate("/Precot/QA/Inward033/Summary");
      })
      .catch((err) => {
        setLoading(false);
  ...
  const checkgetExists = async (date) => {
    try {
      ...
      setlineId8(response.data.body.line1[7].line_id);
      SetSpecification8(response.data.body.line1[7].specification);
      setobsevation8(response.data.body.line1[7].observation);

      //  citical
      setNumber1(response.data.body.line2[0].no_of_defects);
      setlineId9(response.data.body.line2[0].line_id);
      setMaxdefect1(response.data.body.line2[0].maximum_no_of_defects);
      setTotal7(response.data.body.line2[0].total_no_of_defects);

      setNumber2(response.data.body.line2[1].no_of_defects);
      setlineId10(response.data.body.line2[1].line_id);

      setNumber3(response.data.body.line2[2].no_of_defects);
      setlineId11(response.data.body.line2[2].line_id);

      setNumber4(response.data.body.line2[3].no_of_defects);
      setlineId12(response.data.body.line2[3].line_id);

      setNumber5(response.data.body.line2[4].no_of_defects);
      setlineId13(response.data.body.line2[4].line_id);

      //Major

      setlineId14(response.data.body.line2[5].line_id);
      setNumber6(response.data.body.line2[5].no_of_defects);
      setMaxdefect2(response.data.body.line2[5].maximum_no_of_defects);
      setTotal8(response.data.body.line2[5].total_no_of_defects);

      setlineId15(response.data.body.line2[6].line_id);
      setNumber7(response.data.body.line2[6].no_of_defects);

      //Minor
      setlineId16(response.data.body.line2[7].line_id);
      setNumber8(response.data.body.line2[7].no_of_defects);
      setMaxdefect3(response.data.body.line2[7].maximum_no_of_defects);
      setTotal9(response.data.body.line2[7].total_no_of_defects);

      setlineId17(response.data.body.line2[8].line_id);
      setNumber9(response.data.body.line2[8].no_of_defects);

      setlineId18(response.data.body.line2[9].line_id);
  ...
  const saveData = () => {
    ...
    const payload = {
      ...
      iir_no: IIR_No,
      date: dates,
      batch_no: BatchNo === "" ? "NA" : BatchNo,
      lot_qty: LotQty === "" ? "NA" : LotQty,
      item_description: selectedItem,
      aql_sample_size:
        AQl_Sample === "" || AQl_Sample === null || AQl_Sample === undefined
          ? "NA"
          : AQl_Sample,
      supplier_name: Suppliers === "" ? "NA" : Suppliers,
      po_no: PoNo === "" ? "NA" : PoNo,
      item_code: Item_code === "" ? "NA" : Item_code,
      invoice_no: invoice,
      gr_date: newDate,
      gr_no: GRNO === "" ? "NA" : GRNO,
      ...
      line1: [
        ...
        {
          parameter: "Weight of cap (gms)",
          specification: Specification8 === "" ? "NA" : Specification8,
          observation: observation8 === "" ? "NA" : observation8,
          ...(fetchedId && { id: fetchedId }),
      ...
      line2: [
        {
          ...
          defects: "Scratches/Dents/Damages",
          no_of_defects: Number1 === "" ? "0" : Number1,
          total_no_of_defects: total7,
        ...
        {
          category: "Critical(AQL - Nil)",
          defects: "Contamination (Foreign Matl.)",
        ...
        },
        {
          ...
          defects: "No sharp at end",
          no_of_defects: Number6 === "" ? "0" : Number6,
          total_no_of_defects: total8,
        ...
        <div>
          ...
          >
            ...
            <tbody>
              ...
              <tr>
                <Td colSpan="1">2</Td>
                <Td colSpan="5">Length of jar (mm)</Td>
                <Td colSpan="5">
                  <input
                    type="text"
                    className="inp-new"
              ...
              <tr>
                <Td colSpan="1">3</Td>
                <Td colSpan="5">Diameter of jar (mm)</Td>
                <Td colSpan="5">
                  {" "}
                  <input
                    type="text"
              ...
              <tr>
                <Td colSpan="1">4</Td>
                <Td colSpan="5">Weight of jar (gms)</Td>
                <Td colSpan="5">
                  <input
                    type="text"
                    className="inp-new"
              ...
              <tr>
                <Td colSpan="1">5</Td>
                <Td colSpan="5">Length of cap (mm)</Td>
                <Td colSpan="5">
                  <input
                    type="text"
                    className="inp-new"
              ...
              <tr>
                <Td colSpan="1">6</Td>
                <Td colSpan="5">Diameter of cap (mm)</Td>
                <Td colSpan="5">
                  <input
                    type="text"
                    className="inp-new"
              ...
              <tr>
                <Td colSpan="1">7</Td>
                <Td colSpan="5">Weight of cap (gms)</Td>
                <Td colSpan="5">
                  <input
                    type="text"
                    className="inp-new"
                    value={Specification8}
                    onChange={(e) => SetSpecification8(e.target.value)}
                    style={{ width: "100%" }}
                    disabled={condition}
                  />
                </Td>
                <Td colSpan="4">
                  <input
                    ...
                    className="inp-new"
                    value={observation8}
                    onChange={(e) => setobsevation8(e.target.value)}
                    style={{ width: "100%" }}
                    disabled={condition}
                  />
                </Td>
          ...
          >
            ...
            <>
              <tr>
                ...
                <Td colSpan="4">Scratches/Dents/Damages</Td>
                <Td colSpan="4">
                  <input
                    type="text"
                    className="inp-new"
              ...
              <tr>
                <Td colSpan="1">2</Td>
                <Td colSpan="4">Inconsistent Length</Td>
                <Td colSpan="4">
                  <input
                    type="text"
                    className="inp-new"
              ...
              <tr>
                <Td colSpan="1">3</Td>
                <Td colSpan="4">Inconsistent Diameter</Td>
                <Td colSpan="4">
                  <input
                    type="text"
                    className="inp-new"
              ...
              <tr>
                <Td colSpan="1">4</Td>
                <Td colSpan="4">Contamination (Foreign Matl.)</Td>
                <Td colSpan="4">
                  <input
                    type="text"
                    className="inp-new"
        ...
        <div>
          ...
          >
            <tr>
              ...
              <Td colSpan="4">No sharp at end</Td>
              <Td colSpan="4">
                <input
                  type="text"
                  className="inp-new"
            ...
            <tr>
              <Td colSpan="1">2</Td>
              <Td colSpan="4">Color variation </Td>
              <Td colSpan="4">
                <input
                  type="text"
                  className="inp-new"
            ...
            <tr>
              ...
              <Td colSpan="4" rowSpan={3} disabled={condition}>
                {total9}
              </Td>
            ...
            <tr>
              <Td colSpan="1">2</Td>
              <Td colSpan="4">Minor Scratches</Td>
              <Td colSpan="4">
                <input
                  type="text"
                  className="inp-new"
