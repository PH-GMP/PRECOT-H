...
@Data
@Entity
@Table(name = "SPUNLACE_PRODUCT_CHANGE_OVER_CHECK_LIST__F011", schema = AppConstants.schema, uniqueConstraints = {
		@UniqueConstraint(columnNames = { "DATE", "SHIFT", "ORDER_NO_FROM" }) })
public class ProductChangeOverCheckListSpunlaceF011 extends SpunlaceSaveSubmitQA{
